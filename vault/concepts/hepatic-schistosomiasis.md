---
concepts: [hepatic-schistosomiasis]
name: Hepatic Schistosomiasis — "Turtle Back" Sign
subspecialty: [ABD, US]
aliases:
...
## Summary
- **病因與機轉**：血吸蟲(Schistosoma，尤其*S. mansoni*、*S. japonicum*)蟲卵經門脈系統沉積於肝臟**門脈周圍(periportal)**組織，誘發肉芽腫反應與纖維化。[^1]
- **特徵性超音波徵象——Turtle back appearance（龜背徵）**：肝臟粗糙的高回音間隔(hyperechoic septa)分隔相對正常的肝實質島狀區域，形成類似龜殼紋路的網狀外觀，反映**pipestem fibrosis（管狀/管周纖維化）**沿門脈分支分佈。[^1]
...
> **Schistosomiasis（D）**——高回音間隔分隔正常肝實質形成turtle back appearance，反映門脈周圍pipestem fibrosis，為血吸蟲病特徵性表現。[^1]

## 考題
```dataview
list from #交換 where contains(concepts, "hepatic-schistosomiasis")
```
