---
concepts: [gynecologic-thoracic-metastases]
name: Thoracic Metastases from Gynecologic Neoplasms
subspecialty: [CH, ABD]
aliases:
  - gynecologic thoracic metastasis
...
## 考題
```dataview
list from #交換 where contains(concepts, "gynecologic-thoracic-metastases")
```
