...
- **機轉/關聯**：**後顱窩過小或擁擠**（size-content mismatch）→ **craniosynostosis（顱縫早閉,致後顱窩小）支持 Chiari I**（2016-171 正解 D）。[^1]
- **合併**：syringomyelia、脊柱側彎、腦幹壓迫、hydrocephalus。[^1]
- **與 Chiari II 區別**：**myelomeningocele、callosal dysgenesis、medullary（cervicomedullary）spur／kink** 為 **Chiari II** 特徵,非 I。[^1]

> [!note] 考點：何者支持 Chiari I?
> **Craniosynostosis（顱縫早閉→後顱窩小）**。myelomeningocele、callosal dysgenesis、medullary spur 屬 Chiari II。[^1]
