---
concepts: [adnexal-torsion]
name: Adnexal (Ovarian) Torsion — Imaging Features
subspecialty: [GU]
aliases:
  - ovarian torsion
  - adnexal torsion
...
**附件扭轉的病因陷阱：多以「良性」病灶為 lead point（生理性濾泡/黃體囊腫最常見，其次皮樣囊腫、paraovarian cyst），而非惡性腫瘤——惡性腫瘤常與周圍沾黏而不易扭轉，5-10 cm 大小之腫塊風險最高。** 判讀分水嶺：**卵巢腫大（>4 cm 或 >20 cm³）+ 水腫基質把濾泡推到周邊（peripheral follicle）+ whirlpool/扭轉血管蒂＝扭轉；Doppler「靜脈血流先受影響」，動脈因雙重供血可保留——所以「動脈血流正常」不能排除扭轉，要找靜脈波型。**
...
- **Doppler 判讀鐵律**：**靜脈波型先消失**，動脈可正常——**別因動脈有血流就排除扭轉**；有靜脈血流→卵巢較可能存活（影響手術決策）。[^1]
- **lead point 辨識**：找底下良性囊腫/皮樣，惡性少見；報告時描述病灶大小（5-10 cm 風險高）。[^1]
- **次要徵象**：骨盆游離液、子宮偏向扭轉側、卵巢位置異常（移位至中線/對側）。[^1]
- **陷阱**：早期/間歇扭轉動脈血流正常易漏診；水腫基質使卵巢回音增強勿誤為出血。[^1]

## 臨床重點（5 句）
1. **良性為主**：扭轉 lead point 多為良性（生理囊腫/黃體/皮樣），非惡性。[^1]
2. **Doppler**：靜脈先受影響、動脈可保留；正常動脈不排除扭轉。[^1]
3. **最特異徵象**：whirlpool/扭轉血管蒂（<1/3 可見）。[^1]
4. **側性**：右 > 左（3:2）；孕期約占 20%，為婦科急症。[^1]
5. **手術時效**：有靜脈血流提示存活，及時 detorsion 可保留卵巢。[^1]

> [!note] 考點：關於adnexal torsion典型影像表現，何者「非」正確？
> 「**更常與惡性卵巢腫瘤相關**」為非——附件扭轉多與良性病灶（生理性/黃體囊腫、皮樣囊腫、paraovarian cyst）相關，惡性腫瘤因沾黏反而少見。卵巢腫大水腫/出血、子宮偏向扭轉側、whirlpool（twisted vascular pedicle）徵象皆為正確之典型影像特徵。[^1]
