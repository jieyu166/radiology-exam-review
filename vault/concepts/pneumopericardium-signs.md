...
- **Deep sulcus sign**：仰臥位**氣胸**,肋膈角異常深而透亮。[^2]
- **Bulging fissure sign**：**Klebsiella 肺炎**（葉膨脹致葉間裂膨出）。[^2]
- **Luftsichel sign**：**LUL 塌陷**（LLL 上節段疝入,主動脈旁新月透亮，見 [[lobar-atelectasis]]）。[^2]

> [!note] 考點：pneumopericardium 可見何徵象?
> **Continuous diaphragm sign**。deep sulcus＝氣胸、bulging fissure＝Klebsiella、Luftsichel＝LUL 塌陷。[^1][^2]
