---
concepts: [covid19-chest-ct]
name: COVID-19 — Chest CT Imaging Features & Role
subspecialty: [CH]
aliases:
  - COVID-19 CT
  - crazy paving
...
- **併發症**：細菌性肺炎（二次感染）、氣胸、pneumomediastinum、**急性肺栓塞（thromboembolic）**。[^1]

## 放射科醫師影像判讀重點
- **分布指紋**：雙側、周邊/胸膜下 + peribronchovascular GGO 為 COVID 典型；單側/中央/下葉單發較不典型。[^1]
- **時序演變**：早期 GGO → 高峰期（9-13 天）crazy paving/OP → 恢復期纖維化樣條索/reverse halo。[^2]
- **OP 型態**：perilobular、reverse halo（atoll）、周邊實變是 COVID 常見 OP 表現。[^1][^2]
...
3. **高峰期**：9-13 天呈非典型/機化性肺炎表現。[^2]
4. **非典型徵象**：淋巴結腫大/肋膜積液/微結節/空洞 → 想其他病因。[^2]
5. **併發症**：二次細菌感染、氣胸、pneumomediastinum、肺栓塞需主動評估。[^1]

> [!note] 考點：關於COVID-19影像特徵何者錯誤？
> **顯影劑胸部 CT 為 COVID-19 日常臨床實務中之第一線篩檢影像工具（B）**為錯誤——CT 非診斷所必需，應保留用於評估併發症/鑑別，多數放射學會不建議常規篩檢 CT。典型 CT（雙側周邊 GGO/crazy paving/實變/支氣管血管束增厚/牽引性支氣管擴張）、高峰期（9-13 天）呈非典型/機化性肺炎、縱膈淋巴結腫大/肋膜積液/多發微小結節/空洞化屬相對非典型徵象，皆為正確。[^1][^2]
