---
concepts: [retroperitoneal-tumors]
name: Primary Retroperitoneal Tumors
subspecialty: [ABD]
aliases:
...
**後腹腔原發惡性腫瘤以肉瘤為主：liposarcoma（33%）> leiomyosarcoma（28%）> MFH/UPS（19%）。Myelolipoma 為良性腫瘤，不屬於原發惡性腫瘤。**
...
## 考題
```dataview
list from #交換 where contains(concepts, "retroperitoneal-tumors")
```
