---
concepts: [axillary-lymph-node-levels]
name: Axillary Lymph Node Levels (Relative to Pectoralis Minor)
subspecialty: [Breast]
aliases:
  - axillary node levels
  - axillary lymph node level I II III
  - pectoralis minor lymph node
  - 腋窩淋巴結分級
dateRev: 2026-07-02
---
...
**腋窩淋巴結分level以胸小肌(pectoralis minor)為解剖界標：Level I位於胸小肌下緣外側（下方）、Level II位於胸小肌深面（正後方）、Level III位於胸小肌上緣內側（上方）——「I在下外、II在後、III在上內」是記憶口訣。**

## Summary
- **Level I**：位於胸小肌**下緣外側／下方(below the lower edge of pectoralis minor)**。[^1]
- **Level II**：位於胸小肌**深面／正後方(beneath/posterior to pectoralis minor)**。[^1]
...
> **Level 2位於胸小肌深面（beneath pectoralis minor，B）**——Level I實際在胸小肌下方、Level III實際在胸小肌上方，選項A、C之方位描述有誤。[^1]

## 考題
```dataview
list from #交換 where contains(concepts, "axillary-lymph-node-levels")
```
