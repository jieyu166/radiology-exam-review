...
## Summary
- **與皮質連續、等回音**：與正常腎皮質相連、回音/回音紋理相同（option A、B 正確）。[^1]
- **突入腎竇**：皮質組織夾在錐體間、**向腎竇內突出（projection into renal sinus）**(option D 正確);IVU 上可推移/變形腎盞、模擬腫塊。[^1]
- **腎輪廓保留**：辨識關鍵是**腎外緣（outline）維持正常**;故「**腎表面凹陷（renal surface indentations）**」**不是**其常見超音波發現＝題目正解（2016-135 正解 C）。[^1]
- 好發腎中段、左側較多。[^1]
