---
concepts: [epiphyseal-bone-tumors]
name: Epiphyseal Bone Lesions (DDx)
subspecialty: [MSK]
aliases:
  - epiphyseal tumors
  - chondroblastoma
...
## Summary
- **典型骨骺病灶**：[^1][^2]
  - **Chondroblastoma**：**第二~三十年（10–25 歲）、男略多、骨骺/apophysis 未閉**；邊界清、可有軟骨基質鈣化；為骨骼未成熟者最常見良性骨骺腫瘤之一。
  - **Giant cell tumor**：**骨骺已閉**後；偏心、延伸至軟骨下骨、非硬化緣。
  - **Clear cell chondrosarcoma**：骨骺（對比一般軟骨肉瘤的 metadiaphyseal）。
  - 感染（Brodie/骨骺膿瘍）、(偶) osteosarcoma 延伸至骨骺。
- **Ewing sarcoma**：好發**骨幹/metadiaphysis**（mid-diaphysis 33%、metadiaphysis 44%、metaphysis 15%、**epiphysis 僅 1–2%**）→ 不屬骨骺病灶。[^1]
...
## 考題
```dataview
list from #交換 where contains(concepts, "epiphyseal-bone-tumors")
```
