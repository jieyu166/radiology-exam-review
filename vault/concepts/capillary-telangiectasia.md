...
## Summary
- **好發部位**：以橋腦最常見（約 **80%**）；亦可見於中腦、基底節與皮質。[^1]
- **病理**：擴張微血管之間**夾雜正常腦實質**；「沒有間質腦組織」是 cavernoma 的特徵，非 capillary telangiectasia。[^1]
- **臨床**：多無症狀，屬偶然發現。[^1]
- **影像**：T1/T2 多不顯；對比後為花邊狀／點狀淡強化，SWI/GRE 為低訊號 blooming。[^1]
