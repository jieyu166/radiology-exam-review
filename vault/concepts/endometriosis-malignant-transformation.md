...
## Summary
- **組織型（EAOC）**：**endometrioid adenocarcinoma（~66.7%，最常見）> clear cell adenocarcinoma（~14.8%）**；serous/mucinous 與內膜異位關聯低。[^1][^3]
- **風險/發病**：EAOC 發生率約 **1-2%**；發病較無內膜異位之卵巢癌**早 10-20 年**。[^2][^3]
- **MRI**：實質腫塊 **T1/T2 皆中等訊號**；**囊內強化壁結節（enhancing mural nodule）於 T1WI 高度懷疑惡性轉化**；T2 shading 消失、病灶增大、對側卵巢病灶、子宮內膜增厚為輔助警訊。[^1][^2]
- **腫瘤標記**：**HE4 與 CA125 升高**可提高卵巢癌診斷準確度、有助鑑別卵巢癌 vs endometrioma（並非不會升高）。[^2]
