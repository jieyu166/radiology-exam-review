---
concepts: [hemichorea-hemiballism]
name: Hemichorea-Hemiballism (Nonketotic Hyperglycemia)
subspecialty: [NR]
aliases:
...
## Summary
- **成因**：通常源自**糖尿病之非酮性高血糖（nonketotic hyperglycemia）**。[^1]
...
> **Hypodensity on non-contrast CT, hyperintensity on T1WI（C）**——非顯影CT應為高密度（hyperdense），非低密度。[^1]

## 考題
```dataview
list from #交換 where contains(concepts, "hemichorea-hemiballism")
```
