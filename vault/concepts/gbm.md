---
concepts: [gbm]
name: Glioblastoma (GBM) — Features
subspecialty: [NR]
aliases:
  - glioblastoma
  - GBM
...
## Summary
- **典型 MRI**：白質為中心、**不規則周邊（環狀）強化、中央壞死、周圍 vasogenic edema**（內含浸潤腫瘤）。[^1]
- **出血**：腫瘤內出血可見（急性可似中風）。[^1]（選項 B 為特徵）
- **強化**：厚、不規則環狀強化。[^1]（選項 D 為特徵）
- **Perifocal（vasogenic）edema**：常見且明顯。[^1]（選項 C 為特徵）
...
[^2]: 綜合 2021 WHO CNS5 分類與膠質瘤影像通則：GBM=IDH-wildtype（grade 4，微血管增生＋壞死）、butterfly glioma 跨胼胝體、IDH-mutant 較常額葉/壞死少、tumefactive demyelination 開放環徵。依摘要與分類共識整理，未逐句讀單一全文。
