...
## Summary
- **大小/型態**：常**大型（>4–6 cm）**;小病灶可均質,**大病灶因壞死/出血而異質**。[^1]
- **強化/鈣化**：周邊不均勻強化、中央壞死;**約 30% 鈣化**。[^1]
- **血管侵犯**：**侵犯腎靜脈、IVC、肝相對常見**（腫瘤栓）。[^1]
- **本題**：6 cm 右腎上腺腫塊、異質性周邊強化、壞死、鈣化、早期侵犯 → **ACC**（2016-136 正解 A）。鑑別:pheochromocytoma（顯著強化、T2 light-bulb、10% rule）、neuroblastoma（兒童、跨中線、包繞血管）、adenoma（小、富脂、快 washout）。[^1]
