---
concepts: [evali-vaping-lung-injury]
name: EVALI (E-cigarette/Vaping Product Use-Associated Lung Injury)
subspecialty: [CH]
aliases:
  - EVALI
  - vaping lung injury
...
## 考題
```dataview
list from #交換 where contains(concepts, "evali-vaping-lung-injury")
```
