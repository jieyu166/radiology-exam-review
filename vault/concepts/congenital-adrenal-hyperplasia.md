---
concepts: [congenital-adrenal-hyperplasia]
name: Congenital Adrenal Hyperplasia (CAH) — Ultrasound
...
## 考題
```dataview
list from #交換 where contains(concepts, "congenital-adrenal-hyperplasia")
```
