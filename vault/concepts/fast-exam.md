---
concepts: [fast-exam]
name: FAST / E-FAST Ultrasound (Free Fluid in Trauma)
subspecialty: [US]
aliases:
  - FAST
  - FAST scan
...
- **臨床定位**：床邊即時 POCUS，用於創傷病人快速分流（尤其血液動力學不穩者）；陽性自由液體＋不穩 → 直接送開刀。[^1]
- **四視窗**：subxiphoid（心包）、RUQ（Morrison hepatorenal recess，仰臥最低位、最敏感）、LUQ（splenorenal/perisplenic）、suprapubic（pouch of Douglas）。[^1]
- **E-FAST（extended）**：加雙側前胸（氣胸：lung sliding 消失、barcode sign）與肋膈角（血胸）。[^1]
- **限制**：對少量積血、後腹膜與中空臟器/實質損傷敏感度有限；陰性 FAST 不能排除損傷 → 穩定病人仍須 CT。[^1]

## 放射科醫師影像判讀重點
- **檢查目標二元化**：FAST 只回答「有沒有游離液體（腹腔/心包積血）」，**不評估**器官撕裂分級、不測主動脈、不做 Doppler 看肝/門靜脈——這些是易混選項與 CT 的範疇。[^1][^2]
- **四視窗掃描順序與低位點**：subxiphoid（心包）→ RUQ Morrison pouch（仰臥最低位、**最敏感**）→ LUQ（液體常先積膈下/脾上極而非脾腎間，探頭需更後上）→ suprapubic（Douglas pouch，站立/半坐位全身最低）。[^1][^3]
- **游離液外觀**：呈無回音（黑色）至低回音、積於 dependent 腔隙；心包積液真陽性應繞行至降主動脈前方，且填塞時見舒張期右心塌陷。[^1][^3]
- **E-FAST 胸部加做**：氣胸看 lung sliding 與 comet-tail（任一存在即排除該點）；M-mode 正常 seashore、氣胸為 barcode/stratosphere；lung point 特異性近 100%；血胸見橫膈上無回音帶＋spine sign。US 偵測氣胸優於仰臥 CXR。[^1][^3][^4]
- **偵測門檻量（技術限度）**：肝腎隱窩平均需 >500 mL 才陽性、骨盆視窗較敏感（~157 mL）；小量積血可偽陰，穩定病人連續追蹤可提高敏感度。[^3]
- **偽陽性 mimic（判讀陷阱）**：腎周脂肪的「double-line」易誤為肝腎/脾腎間游離液；心包脂肪墊有內部回音、僅見於前方且不隨心動變形，勿誤為心包積液；育齡女性 Douglas pouch ≤50 mL 為生理性。[^3]
- **陰性不能排除損傷**：孤立實質器官損傷但無游離液、後腹腔與中空臟器/腸繫膜損傷是 FAST 盲區；與 CT 直接比較之研究顯示實質損傷敏感度僅約 63%，穩定病人仍須 CT。[^1][^5]

## 四標準視窗判讀重點
游離液體在超音波呈**無回音（黑色）至低回音**，積聚於 dependent（重力最低）腔隙；探頭找的就是器官交界處的黑色帶。[^1][^3]

| 視窗 | 解剖腔隙 | 判讀重點 |
| --- | --- | --- |
| **RUQ 右上腹** | **Morrison pouch（肝腎隱窩 hepatorenal recess）** | 仰臥位腹腔**最敏感**低位點；肝腎間出現無回音游離液 → 陽性。掃描務必含**肝下緣與右側膈下、下極腎旁溝**（小量積血先積此）[^1][^3] |
| LUQ 左上腹 | splenorenal / 脾周 / **膈下（subphrenic）** | 左側液體常先積**膈下與脾上極**，而非脾腎間；探頭需更後上（後腋線、較高肋間）[^1][^3] |
| 骨盆 Suprapubic | **pouch of Douglas（直腸子宮陷凹）／膀胱後** | 站立／半坐位**全身最低位**；經膀胱當聲窗，橫切＋縱切找膀胱後／後上方游離液[^1][^3] |
| Subxiphoid 劍突下 | 心包腔 | hemopericardium → tamponade；心包腔內無回音帶，**舒張期右心塌陷**為填塞徵象[^1] |

### E-FAST 加做：胸部
- **氣胸**：高位（仰臥取前胸第 2–3 肋間）找 **lung sliding** 與 **comet-tail（B-line）**——二者**任一存在即排除**該點氣胸。皆消失才可疑。[^1][^3][^4]
- **M-mode 佐證**：正常為 **seashore sign（海灘徵）**；氣胸時失去動態、呈平行靜止線即 **barcode／stratosphere sign（條碼／平流層徵）**。[^1][^4]
- **lung point（肺點）**：滑動與無滑動交界，為氣胸**特異性近 100%** 的確診徵象（但敏感度有限、大量氣胸找不到）。[^3][^4]
- **血胸**：肋膈角／肋膈隱窩、橫膈上方出現無回音帶；血液作聲窗使脊椎在橫膈上方仍可見＝**spine sign（脊椎徵）**，正常含氣肺不會出現。[^3]
- 肺超音波偵測氣胸**優於仰臥胸部 X 光**（US 敏感度約 49–99%、CXR 約 21–76%，特異度均高）。[^4]
...
- **CT 的定位**：穩定病人的確診與分級工具——評估實質器官損傷程度、後腹腔、血管外滲（contrast extravasation）；**陰性 FAST 的穩定病人仍須 CT** 排除 FAST 盲區損傷。[^1][^5]

## 鑑別與報告要點
- 陽性：dependent 區無回音/低回音液體（Morrison pouch、脾腎間／膈下、Douglas pouch）。[^1]
