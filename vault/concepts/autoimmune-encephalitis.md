---
concepts: [autoimmune-encephalitis]
name: Autoimmune Encephalitis — Overview
subspecialty: [NR]
aliases:
...
> **以上皆對（E）**——四項敘述（臨床光譜、分類依據、影像角色、好發腫瘤）皆正確。[^1]

## 考題
```dataview
list from #交換 where contains(concepts, "autoimmune-encephalitis")
```
