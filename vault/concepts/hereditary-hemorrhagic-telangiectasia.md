---
concepts: [hereditary-hemorrhagic-telangiectasia]
name: Hereditary Hemorrhagic Telangiectasia (Osler-Weber-Rendu)
subspecialty: [IR, CH]
aliases:
...
**HHT（Osler-Weber-Rendu症候群）與肺動靜脈畸形（PAVM）的雙向關聯要分清楚：約60%以上PAVM病人患有HHT；而HHT病人約有「至少一半（不是少於10%）」有肺動靜脈畸形/肺部侵犯。所以「少於10% HHT病人有PAVM」是錯誤敘述。**

## Summary
- **別名**：Osler-Weber-Rendu syndrome；體染色體顯性遺傳之血管發育異常。[^1]
- **侵犯範圍**：可侵犯**黏膜、皮膚、肺、腦、腸胃道**（微血管擴張與動靜脈畸形）。[^1]
...
> **Less than 10% of patients with hereditary hemorrhagic telangiectasia have pulmonary AVMs（D）**——實際上至少一半HHT病人有肺部侵犯/PAVM。[^1]

## 考題
```dataview
list from #交換 where contains(concepts, "hereditary-hemorrhagic-telangiectasia")
```
