...
- **治療**:外科 **ureterolysis 並把輸尿管『外側(lateral)轉位』(lateral transposition)** + 網膜包覆——正因斑塊把輸尿管往**內側**拉,手術需外移之。[^1]
- **IVP/IVU 三聯**:①上段輸尿管腎積水 ②輸尿管**中 1/3 內側偏移(medial deviation)** ③輸尿管漸進變細(extrinsic);故「**外側(lateral)偏移**」**錯誤**(2016-094 正解 B;應為 medial)。[^2]
- **CT 典型**:腎下主動脈（infrarenal aorta）周圍**confluent soft-tissue plaque**,沿髂動脈向下延伸,好發 **L4–L5** 高度;平掃密度近腰大肌(約 1–25 HU);斑塊**包繞主動脈前/側面但不把主動脈往前抬離脊椎**,亦不向後楔入主動脈與脊椎間——此為良性 RPF 影像核心特徵。[^3][^4]
- **CT 強化隨纖維化活性**:活動(發炎)期斑塊較強化;成熟纖維化期密度趨穩、強化較弱。[^3]
- **MRI 訊號隨活性**:活動期 T2 加權**高訊號**且 gadolinium **明顯強化**(反映水腫/血管化發炎);慢性成熟纖維化 T2 趨**低訊號**、強化輕微;T1 多為均勻低訊號。MRI 對追蹤活性與治療反應較 CT 敏感。[^3][^5]
- **FDG-PET/CT**:評估**發炎活性**而非僅形態,可標定最活躍部位作切片導引、追蹤類固醇/免疫治療反應;惟活動性 RPF 與惡性皆可高攝取,單看 SUV 無法可靠鑑別良惡。[^5][^6]
...
## 放射科醫師影像判讀重點
- **IVP／IVU（三聯）**：上段輸尿管腎積水 ＋ 輸尿管中 1/3 **內側偏移（medial deviation）** ＋ 病段漸進性 tapering（extrinsic 壓迫）；判讀時務必確認偏移方向為「內側」，「外側偏移」即為考題陷阱。[^2][^5]
- **CT（形態辨識）**：腎下主動脈周圍 confluent soft-tissue plaque，平掃密度近腰大肌（約 1–25 HU），好發 L4–L5、可沿髂動脈向下延伸；良性 RPF **貼脊椎、不把主動脈往前抬離脊椎**，此為與惡性鑑別之核心形態。[^3][^4]
- **CT 強化判活性**：活動（發炎）期斑塊強化明顯，成熟纖維化期強化趨弱、密度趨穩——強化程度可作為分期判讀依據。[^3]
- **MRI（活性判讀最佳）**：活動期 T2 高訊號＋釓明顯強化（水腫／血管化發炎），慢性期 T2 低訊號、強化輕微，T1 多為均勻低訊號；追蹤治療反應之敏感度優於 CT。[^3][^5]
- **FDG-PET/CT**：標定最活躍部位供切片導引與治療反應追蹤；但活動性 RPF 與惡性皆可高攝取，單看 SUV 無法可靠鑑別良惡，判讀須併形態。[^5][^6]
- **良惡鑑別分水嶺（pitfall）**：淋巴瘤／惡性常「floating aorta sign」（主動脈前抬離脊椎，一系列 MDCT 約 43.5% vs RPF 約 5.3%）、bulky 分葉、把輸尿管推向**外側**；良性 RPF 貼脊椎、邊緣平滑、把輸尿管牽向**內側**。[^4][^8]

## 臨床重點（5 句）
- 病因以特發性最多，其次為 IgG4 相關、藥物與惡性；特發性中約 35–60% 屬 IgG4-RD。[^5][^7]
- 好發年長男性，IgG4 相關者常合併自體免疫胰臟炎等多器官侵犯，對類固醇反應佳。[^5][^7]
- 自體免疫胰臟炎患者於診斷時約 20% 併有後腹膜纖維化（非 50%）。[^9]
- 臨床常以腰背痛、下肢水腫或腎功能異常（輸尿管 entrapment 致阻塞性尿路病變）表現。[^5]
- RPF 屬慢性發炎過程，可併發炎性腹主動脈瘤（IAAA），佔腹主動脈瘤 3–10%，男女比懸殊。[^9]
...
[^3]: **Tier 1**. Caiafa RO, et al. *Retroperitoneal Fibrosis: Role of Imaging in Diagnosis and Follow-up*. RadioGraphics 2013;33(2):535–552. DOI: [10.1148/rg.332125085](https://doi.org/10.1148/rg.332125085)。CT 顯示腎下主動脈周圍 confluent 低密度斑塊（平掃近腰大肌、約 1–25 HU）、L4–L5 高度、強化依纖維化分期;MRI 活動期 T2 高訊號／明顯強化、慢性纖維化 T2 低訊號／輕度強化。（出版頁 RSNA 付費全文,facts 經 StatPearls 與 PMC 二次來源交叉佐證,見 [^5]。）
[^4]: **Tier 1**. Cura M, et al.（AJR 影像鑑別文獻群）及 Amis ES Jr. *Retroperitoneal fibrosis*. AJR 1991;157(2):321–329, DOI: [10.2214/ajr.157.2.1853814](https://doi.org/10.2214/ajr.157.2.1853814)：良性 RPF 不把主動脈前移、輸尿管內側偏移;惡性／淋巴瘤主動脈前抬（anterior elevation）＋輸尿管外側偏移。AJR 全文 403 付費,核心鑑別點以 StatPearls [^5] 與 MDCT 研究 [^8] 佐證。
[^5]: **Tier 2（StatPearls / NCBI Bookshelf）**. Engelsgjerd JS, et al. *Retroperitoneal Fibrosis*. StatPearls 2024（NBK482409, [連結](https://www.ncbi.nlm.nih.gov/books/NBK482409/)）：輸尿管 medial deviation 定義為兩側輸尿管間距 ≤5 cm 或直接重疊於腰椎前;MRI 活動期 T2 高訊號／釓強化、慢性期低訊號;FDG-PET 評估活性;IgG4-RD 佔特發性 RPF 約 35–60%。
