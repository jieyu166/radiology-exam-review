---
concepts: [ankle-mortise-view]
name: Ankle Radiograph — Mortise View Technique
subspecialty: [MSK]
aliases:
  - ankle mortise view
...
> **C（此視角可同時顯示內外側關節間隙）為真**。Mortise view為足部**內轉**15-20度（非90度AP旋轉），使內外髁等高;標準AP view因距骨遮蔽外髁，外側關節間隙較不清楚。[^1]

## 考題
```dataview
list from #交換 where contains(concepts, "ankle-mortise-view")
```
