---
concepts: [invasive-lobular-carcinoma]
...
- **判讀陷阱**：mammography 敏感度低、易遲診且大小低估(可達 70%);**勿因無鈣化即排除 ILC**;新診斷 ILC 建議**術前 MRI** 評估真實範圍/對側,可降低再切除率。[^1][^2][^3]
- **轉移型態（ILC 特色）**：肝、骨、肋膜轉移率與 IDC 相當;但**不尋常部位轉移在 ILC 不少見**——**腸胃道、泌尿生殖道、腹膜/漿膜表面、腦膜（leptomeningeal）、心肌**（可呈 linitis-plastica 樣胃壁或腹膜癌病樣播散）;追蹤時對這些非典型部位症狀要提高警覺。臨床上 ILC **較 IDC 常需乳房全切、對化療反應較差**。[^2]
- **鑑別診斷(DDx)**：IDC(腫塊較成團、較常含鈣化)、radial scar(中央透亮、長毛刺)、術後疤痕(對照病史與位置)、fibromatosis(desmoid-type，少見)。[^1][^2]

## 放射科醫師影像判讀重點

- **乳攝（mammography）**：最常見為 **spiculated mass**，其次 **架構扭曲／不對稱密度**；敏感度僅 57–81%（緻密乳房可低至 ~30%）、偽陰性率高於其他浸潤癌，常**僅單一投影可見**；少數以 **shrinking breast** 表現，須與舊片及左右對稱比對。[^2][^3][^4]
- **關鍵陷阱——鈣化**：**微鈣化 <10%、非 ILC 特徵**（考題若稱「鈣化是其特徵」即錯）；**勿因無鈣化即排除 ILC**；16% 可 mammographically occult 或看似良性。[^1][^2][^3]
- **超音波（US）**：不規則低回音腫塊、邊界不清、**後方聲影**；範圍常被低估（18–53%），對多發評估不足。[^2][^3]
- **MRI（範圍評估首選）**：敏感度最高（>95%，約 83–100%），以 **non-mass enhancement（線狀／節段分布）**為特徵；最準確評估**範圍、multifocal/multicentric 與 bilateral**，約 1/3 病人因此偵測到額外病灶——新診斷 ILC 建議**術前 MRI**以降低再切除率。[^1][^2][^5]
- **DDx／病理徵**：與 IDC（較成團、較常含鈣化）、radial scar、術後疤痕、fibromatosis 區分；組織學 **bull's-eye pattern＝腫瘤細胞環繞癌變或正常腺泡/乳管**（方向不可顛倒）。[^1][^6]
- **判讀陷阱**：各模態皆易低估範圍（mammo 大小低估可達 70%）；single-file 生長、少腫塊效應致範圍評估依賴 MRI。[^2][^3][^5]

## 臨床重點（5 句）

- 占所有乳癌 **5–10%**，最常見乳癌型態仍為 invasive ductal carcinoma（IDC）。[^1]
- 組織學特徵為 **single-file（Indian file）線狀浸潤＋E-cadherin 缺失**，故少腫塊效應、少破壞正常結構。[^1][^2]
- **轉移型態特殊**：肝/骨/肋膜同 IDC，但 GI 道、泌尿生殖道、腹膜/漿膜、腦膜（leptomeningeal）、心肌等**不尋常部位轉移在 ILC 不少見**，追蹤時須提高警覺。[^2]
- 臨床上 ILC **較 IDC 常需乳房全切、對化療反應較差**。[^2]
- 分型含 classic／signet ring／alveolar／pleomorphic 等亞型。[^6]

> [!note] 考點：關於 ILC 特徵,何者「非」?
> 「**鈣化是其特徵**」非——ILC **微鈣化少見(<10%)、非特徵**。占乳癌 ~10%(A)、單列生長(B)、常僅單一投影可見(D)皆正確。[^1]

### 參考來源
[^1]: *Invasive lobular carcinoma of the breast*. Radiopaedia.org（輔助層級，accessed 2026-06-18）：「represent **5-10%** of all breast cancer」;乳房攝影「**spiculated mass lesion (most common)**, asymmetrical densities, architectural distortions, **microcalcifications (<10%)**;**16% ... mammographically occult or benign**」;單列浸潤、E-cadherin 缺失。
[^2]: **Tier 1（全文已讀，via 個人訂閱 pubs.rsna.org，accessed 2026-07-01）** — *Invasive Lobular Carcinoma: A Multimodality Imaging Primer.* RadioGraphics 2021;41(4):939–959. DOI:10.1148/rg.210058。single-file 浸潤、少腫塊效應與少結構破壞致各模態低估;mammo 敏感度 57–81%、MRI（non-mass enhancement）為偵測範圍與 multifocal/multicentric/bilateral 之最準確模態;**不尋常轉移部位＝GI 道、泌尿生殖道、腹膜/漿膜、腦膜、心肌（肝/骨/肋膜同 IDC）;ILC 較 IDC 常需 mastectomy、對化療反應較差**（原文 Teaching Points 與 metastasis/management 段）。
