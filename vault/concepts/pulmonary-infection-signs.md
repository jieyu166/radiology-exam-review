---
concepts: [pulmonary-infection-signs]
name: Signs in Pulmonary Infection (CXR/CT)
subspecialty: [CH]
aliases:
  - monad sign
  - monod sign
...
**肺感染影像徵象,先把『真菌 vs 寄生蟲 vs 氣道』分清楚：**
- 真菌（aspergillus 譜系——air crescent 復原期、monod 真菌球、halo 血管侵犯）、
- 寄生蟲（water-lily 包蟲、signet ring/paragonimiasis）、
- 氣道/其他（tree-in-bud 散播、finger-in-glove 黏液栓、bulging fissure 克雷白氏菌、steeple 哮吼）。
 判讀分水嶺一（最常混淆）：**Air crescent＝angioinvasive aspergillosis 的『復原期』（壞死肺回縮、免疫低下、好預後,~50% 可見）vs Monod＝既存空洞內『可動真菌球（aspergilloma）』、免疫正常**;
 判讀分水嶺二（考題陷阱）：**signet ring sign 在 CT 指『支氣管擴張』（擴張支氣管環＋較小伴行動脈），不是 paragonimiasis 早期表現**。
...
### 真菌（aspergillus 譜系）
- **Air crescent sign**：空洞壁與腔內團塊之間的**空氣新月**;典型為 **angioinvasive aspergillosis 的『復原期』**（免疫恢復→壞死組織回縮）→ **好預後徵象、約 50% 病人可見**;亦見於 hydatid、TB（Rasmussen aneurysm）、abscess。[^1]
- **Monod sign**：既存肺空洞內**可動的真菌球（mycetoma/aspergilloma）**周圍的空氣;典型**免疫正常**病人。[^1]
- **Halo sign（CT）**：結節/腫塊/實變周圍一圈**毛玻璃**（出血/水腫）;典型 **angioinvasive aspergillosis（早期）**,亦見其他感染、GPA、出血性轉移。[^1]
- ⚠ **時效（2024 Fleischner glossary）**：**air crescent 已定為涵蓋『可動腔內真菌球』與『復原期回縮梗塞肺』的傘狀首選術語**——故 air crescent 與 Monod 在新版術語下趨於統一。[^2]

### 寄生蟲
- **Water-lily（camalote）sign**：**包蟲囊（hydatid）**破裂後剝離的內膜漂浮於殘餘囊液上。[^1]
...
> [!note] 考點：signet ring sign
> 「**signet ring sign 為 paragonimiasis 早期薄壁囊**」為非——signet ring sign（CT）主指**支氣管擴張**（擴張支氣管＋較小伴行動脈）。Monod（mycetoma）、finger-in-glove（ABPA）、water-lily（hydatid）皆正確。[^1]
