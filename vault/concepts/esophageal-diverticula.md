---
concepts: [esophageal-diverticula]
name: Esophageal & Hypopharyngeal Diverticula — Classification by Level
subspecialty: [ABD]
aliases:
  - Zenker diverticulum
...
## 考題
```dataview
list from #交換 where contains(concepts, "esophageal-diverticula")
```
