---
concepts: [cardiac-ct-contrast-injection]
name: Cardiac CT — Contrast Injection Protocol
...
- **技術配套**：[^1]
  ...
  - 對比劑用量與流速依管電壓、體型、掃描時間調整。

> [!note] 考點：心臟 CT 對比劑注射的典型建議流速?
> **4-7 cc/秒（C）**。低於此（1-3 mL/s）冠脈對比不足;>7 mL/s 非常規。常配合 saline chaser 與 bolus tracking。[^1]
...
> **4 to 7 cc per second（C）**。冠脈 CTA 需高流速以提升冠脈對比;常配合生理食鹽水追注與 bolus tracking 計時。[^1]

## 考題
```dataview
list from #交換 where contains(concepts, "cardiac-ct-contrast-injection")
```
