---
concepts: [hydronephrosis-mimics]
name: Nonobstructive Mimics of Obstructive Hydronephrosis
subspecialty: [ABD]
aliases:
  - hydronephrosis mimics
  - renal sinus cyst hydronephrosis
  - renal AVM hydronephrosis
  - 水腎症之非阻塞性擬似病灶
dateRev: 2026-07-01
---
...
## Summary
- **腎臟動靜脈畸形(renal AVM)**：可以**都卜勒超音波**與水腎症鑑別(AVM可見高速紊流訊號，非單純無回音管狀擴張構造)。[^1]
- **腎竇囊腫(renal sinus cyst)**：可模擬水腎症，主要以**CT IVP(排泄性尿路攝影)**鑑別——顯示集尿系統呈正常或受壓變窄/移位，但「未」擴張；**並非**以延遲期對比增強超音波(CEUS)作為主要鑑別方法。[^1]
...
> **Renal sinus cyst could be differentiated from hydronephrosis on delayed phase contrast-enhanced ultrasonography (CEUS)（B）**——實際上主要以CT IVP鑑別，此敘述錯誤。[^1]

## 考題
```dataview
list from #交換 where contains(concepts, "hydronephrosis-mimics")
```
