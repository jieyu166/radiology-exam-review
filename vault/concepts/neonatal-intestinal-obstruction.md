---
concepts: [neonatal-intestinal-obstruction]
name: Neonatal Intestinal Obstruction — Causes
subspecialty: [PED]
aliases:
...
**新生兒腸阻塞常見原因：midgut volvulus、duodenal atresia、annular pancreas、meconium ileus、Hirschsprung disease。Acute appendicitis 為最不常見（幾乎不發生於新生兒）。**
...
## 考題
```dataview
list from #交換 where contains(concepts, "neonatal-intestinal-obstruction")
```
