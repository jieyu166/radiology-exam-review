...
- **口服 vs 靜脈水化（oral vs IV，Nat Rev Nephrol 2017）**：CIAKI 預防指引建議以生理食鹽水靜脈輸液擴容（術前 6–12 h 開始、術後維持 4 h）；門診病人無法完成此類靜脈輸液流程時可改用**口服水化（oral hydration）**，且**口服水化在預防 CIAKI 上至少與靜脈生理食鹽水同等有效（at least equally effective）**——以低滲透壓液體口服水化可快速稀釋血管內及腎小管腔對比劑濃度。故上述四項敘述皆為正確（該題答案為「none／以上皆非錯誤」）。[^3]

## 放射科醫師影像判讀重點
- **檢查前準則判斷（誰需預防）**：CIN 預防的核心決策在「風險分層」——既有腎功能不全（eGFR 下降）、糖尿病、脫水、高齡、腎毒性藥物並用者為高風險族群，屬需採取預防措施（volume expansion）的對象；低風險者不需特別介入。此為排程增強檢查前的判斷重點。[^1][^2]
- **預防措施的正誤判斷（避免選錯對策）**：第一線且最廣被接受者為**靜脈水化／擴容（hydration / volume expansion）**（生理食鹽水或碳酸氫鈉，術前術後給予）；**furosemide（利尿劑）不是預防手段**（利尿致有效血容積下降、可能反增腎損傷），steroid 亦無實證支持，hemodialysis 屬已發生腎衰竭後的治療性介入而非預防——判斷「何者為預防方法」時務必把利尿劑/透析排除。[^1][^2]
- **口服 vs 靜脈的選擇判斷**：住院或高風險者以生理食鹽水靜脈擴容（術前 6–12 h 起、術後維持 4 h）；門診且無法完成靜脈流程者可改口服水化，且口服在預防 CIAKI 上至少與靜脈生理食鹽水同等有效——依病人情境彈性選擇路徑，勿誤以為靜脈才是唯一正解。[^3]
...
[^3]: *Oral versus intravenous fluid expansion for contrast-induced acute kidney injury*（Nat Rev Nephrol. 2017 Mar，2018 交換考題詳解 p.359 引用；Tier 1 期刊）。CIAKI 預防指引以生理食鹽水靜脈輸液擴容（術前 6–12 h 開始、術後維持 4 h）；門診病人可改用口服水化；口服水化在預防 CIAKI 上至少與靜脈生理食鹽水同等有效（以低滲透壓液體快速稀釋對比劑於血管及腎小管腔之濃度）。
...
> [!question]- Oral versus intravenous fluid expansion for CIAKI, which is wrong? (2018-442)
> **None（選項5）**——四項敘述皆正確：CIAKI 預防指引以生理食鹽水靜脈擴容(1)、靜脈輸液術前 6–12 h 開始並維持術後 4 h(2)、門診病人無法完成此流程可改口服水化(3)、口服水化在預防 CIAKI 上至少與靜脈生理食鹽水同等有效(4)。故「何者錯誤」之答案為「以上皆非（none）」。[^3]
