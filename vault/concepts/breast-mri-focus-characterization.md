---
concepts: [breast-mri-focus-characterization]
name: Breast MRI — Focus Characterization (Benign Predictors)
subspecialty: [Breast]
aliases:
  - breast MRI focus
...
## 考題
```dataview
list from #交換 where contains(concepts, "breast-mri-focus-characterization")
```
