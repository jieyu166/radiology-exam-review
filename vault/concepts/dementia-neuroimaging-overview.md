---
concepts: [dementia-neuroimaging-overview]
name: Dementia — Proteinopathy Classification & Vascular Dementia Imaging Markers
subspecialty: [NR]
aliases:
  - tauopathy
  - synucleinopathy
...
- **AD**：內側顳葉／海馬迴萎縮為判讀核心指標；建議搭配定量軟體量測（需審慎解讀），並整合CSF、血液生物標記與核醫（如amyloid/FDG-PET）影像。[^3]
- **DLB**：海馬迴相對保留，萎縮偏向紋狀體／中腦／下視丘，與AD形成鑑別對比。[^2]
- **FTD／FTLD**：依亞型呈不對稱之額顳葉萎縮（bvFTD雙側額葉、svPPA左顳葉、nfvPPA左腦島/額葉蓋），可用VBM輔助定位。[^1][^3]
- **PSP**：矢狀面中腦萎縮呈hummingbird sign、軸切面Mickey Mouse sign，屬tauopathy帕金森疊加症候群之影像線索。[^2]
- **血管性失智判讀陷阱**：WMH、腔隙性梗塞、微出血分布須分開評估——腦葉微出血傾向CAA、深部/幕下微出血傾向高血壓性血管病變；勿將白質高訊號一律視為血管性而忽略共病之神經退化。[^1][^3]

## 臨床重點（5 句）
- 失智之診斷須整合臨床病史、神經心理評估、影像與生物標記，影像單獨不足以定論，屬多科整合判斷。[^3]
- 影像的關鍵臨床價值在於排除可治療病因（如常壓性水腦、腫瘤、慢性硬腦膜下出血）並支持特定退化性診斷。[^3]
- AD為最常見之退化性失智，DLB與FTD各有臨床表型（波動性認知/視幻覺、行為/語言障礙）對應不同蛋白病理。[^1][^3]
- 血管危險因子（高血壓、糖尿病）之控制與血管性失智之進展相關，具可介入性。[^1]
- 標準化、疾病導向之影像報告可提升跨科溝通效率與診斷準確度，為臨床照護品質之一環。[^3]

## 陷阱
- 三大蛋白堆積分類（AD/DLB/FTD）與血管性失智三大影像指標（WMH/lacunes/macrohemorrhage分布）皆為「all of the above」型考題，須留意選項是否只列出部分正確敘述而漏未涵蓋其餘同樣正確之選項。[^1]
...
[^3]: **Tier 1** Pizzini FB, Conti E, Bianchetti A, et al. *Radiological assessment of dementia: the Italian inter-society consensus for a practical and clinically oriented guide to image acquisition, evaluation, and reporting*. Radiol Med 2022;127(9):998-1022（據 PubMed，DOI [10.1007/s11547-022-01534-0](https://doi.org/10.1007/s11547-022-01534-0)；實際查證 accessed 2026-07-04）——跨學會共識，提出失智之疾病導向MRI判讀與結構化報告流程（系統性評分萎縮/白質/微出血/小血管病變），並強調整合臨床、CSF、血液生物標記與核醫之多科診斷。原「官方/Radiopaedia」弱來源已由本次 DOI Tier 1 查核升級。

## 考題
```dataview
list from #交換 where contains(concepts, "dementia-neuroimaging-overview")
```
