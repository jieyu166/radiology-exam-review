---
concepts: [cerebral-border-zone-infarct-arteries]
name: Cerebral Border Zone (Watershed) Infarct — Arterial Supply
subspecialty: [NR]
aliases:
  - watershed infarct
...
## 臨床重點（5 句）
1. **border zone**：血管交界、對低灌流敏感、占 5-10% 梗塞。[^1][^2]
2. **external**：皮質交界、多栓塞。[^1][^2]
3. **internal**：深部白質、穿通支、hemodynamic、string-of-pearls。[^1][^2]
4. **穿通支**：lenticulostriate/Heubner/anterior choroidal。[^1]
5. **非供血**：superior hypophyseal artery（下視丘/垂體）。[^1]

> [!note] 考點：何條動脈「不」供應內側分水嶺區(internal border zone)?
> **Superior hypophyseal artery（E）**——此動脈供應下視丘/漏斗部，與大腦內側分水嶺區灌流無關。Recurrent artery of Heubner、lenticulostriate artery、MCA（作為穿通動脈來源）、anterior choroidal artery 之穿通分支皆參與內側分水嶺區供血。[^1][^2]
...
> **Superior hypophyseal artery（E）**——供應下視丘/漏斗部，與大腦內側分水嶺區灌流無關。Recurrent artery of Heubner、lenticulostriate artery、MCA、anterior choroidal artery 之穿通分支皆參與內側分水嶺區供血。[^1][^2]

## 考題
```dataview
list from #交換 where contains(concepts, "cerebral-border-zone-infarct-arteries")
```
