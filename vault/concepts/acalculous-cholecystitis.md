...
## Summary
- **比例**：急性膽囊炎中約 **5-10% 無膽結石**（或結石非致病因子）。[^1][^2]
- **機轉**：**膽汁淤積（biliary stasis）＋膽囊缺血（ischemia）**，非結石阻塞。[^2]
- **好發族群**：**重症/受傷病人**——**創傷、燒傷、敗血症、禁食/TPN、機械通氣、術後、ICU**。[^1][^2]
...
> **10%（A）**（acute acalculous cholecystitis 文獻範圍約 5-10%）。好發重症加護病人（禁食/機械通氣/創傷/燒傷），機轉與膽汁淤積及缺血相關。[^1][^2] 此題於 2018 交換考再次出現（McGraw-Hill Specialty Board Review: RADIOLOGY, GI Q5），內容與答案完全相同。
