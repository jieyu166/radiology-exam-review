---
concepts: [bone-marrow]
name: Bone Marrow (Red vs Yellow) on MRI
subspecialty: [MSK]
aliases:
  - red bone marrow
  - yellow marrow
...
**骨髓轉換像「潮水從末端退向中央」——出生後紅髓從手腳指尖往中軸依序換成黃髓，成人只剩中軸骨與近端長骨保有紅髓。** 判讀關鍵：紅髓因含脂肪細胞（~40% 脂肪），T1 訊號通常仍≥鄰近肌肉或椎間盤，且可呈局灶島狀，易誤判為腫瘤；化學位移影像見到脂肪訊號可助鑑別。Reconversion（黃→紅，見於貧血/造血需求增加）方向相反，但**型態不一定固定可預測**，這也是考試常出現的陷阱選項。

## 判讀骨架

### 一、紅髓 vs 黃髓的 MR 訊號基準
- **成分決定訊號**：紅髓約 40% 脂肪、40% 水、20% 蛋白；黃髓約 80% 脂肪、15% 水、5% 蛋白。脂肪比例是 T1 訊號高低的主因。[^2]
- **黃髓**：T1 高訊號，與皮下脂肪相當。[^2][^3]
- **紅髓**：T1 訊號介於肌肉與脂肪之間——**應高於鄰近椎間盤與椎旁肌肉**，但低於黃髓。[^3]
- **判讀基準線（最重要的內建對照）**：以同一影像的**椎間盤與肌肉**當參考。正常紅髓 T1 訊號要 **高於**兩者；訊號**低於肌肉或椎間盤**即視為可疑的取代性（marrow-replacing）病變。[^3][^4]
- T1（自旋回波）是評估骨髓最敏感的序列；T2 FSE 對瀰漫性病變可靠度較差，不應單獨依賴。[^4]

### 二、正常轉換（conversion，紅→黃）
- 方向：由**周邊往中軸**、四肢**遠端先黃髓化**、近端與中軸骨最後；隨年齡進行，約於 **25–30 歲**完成。[^3]
- 脊椎內方向：自椎體**周邊（subcortical／椎終板下）往中央**進行；隨年齡椎體骨髓相對椎間盤 T1 訊號逐漸上升。[^3]
- 殘留：腰椎、近端肱骨／股骨在成人仍可保有紅髓，屬正常。[^3]

### 三、Reconversion（黃→紅）
- 方向與 conversion **相反**（中軸→周邊），見於造血需求增加。[^3]
- 生理性誘因：**肥胖、吸菸、長期高強度訓練的運動員**；病理性：慢性溶血性貧血等造血需求／骨髓取代性疾病。[^3]
- **型態為斑塊狀、不對稱**，紅髓島嵌於黃髓中——**不循固定可預測型態**，這是與 conversion 的關鍵差異，也是考試陷阱。[^3]
...
### 五、瀰漫 vs 局灶浸潤
- **瀰漫取代**（T1 整體下降、低於椎間盤／肌肉）：白血病、淋巴瘤、瀰漫型多發性骨髓瘤——與瀰漫性紅髓 reconversion 不易分辨，須靠 chemical shift／DWI 解題。[^4][^6]
- **多灶／局灶**：轉移、局灶型多發性骨髓瘤；轉移多呈多發局灶而非瀰漫。多發性骨髓瘤可正常、瀰漫或多灶型表現。[^4]
- **Marrow edema vs 浸潤**：水腫常仍保有部分脂肪訊號、T1 通常**不如腫瘤那麼低**；取代性病變則把脂肪整片置換掉，opposed-phase 不掉訊號、ADC 偏低，可助鑑別。[^4][^6]

## Summary
- **紅髓可局灶/腫塊樣**：**正常紅髓島可呈局灶、似腫塊**,T1 訊號通常仍 ≥ 鄰近肌肉/椎間盤、化學位移有脂肪訊號可助鑑別。[^1][^3]
- **含脂肪**：紅髓**含脂肪細胞**(約 40% 脂肪),非純造血。[^1][^2]
...
## 放射科醫師影像判讀重點
- **T1 是解題主序列、內建對照最重要**：以同一影像的**椎間盤與椎旁肌肉**為基準，正常紅髓 T1 應**高於**兩者；訊號低於肌肉或椎間盤即視為可疑取代性病變。[^3][^4][^7]
- **形態即初步鑑別線索**：取代性病灶（如轉移）於 T1 呈**邊界清楚**低訊號，正常紅髓島多**邊界不清**、對稱、可呈局灶似腫塊——別把正常紅髓島過判為腫瘤。[^3][^7]
- **chemical shift 是關鍵解題工具**：紅髓含微觀脂肪，opposed-phase 相對 in-phase**訊號下降 >20%（1.5T）／>25%（3.0T）**＝良性紅髓；腫瘤取代脂肪後不掉訊號。極小取代病灶可於 opposed-phase 周邊見 etching（勾邊）偽影。[^7][^2]
- **DWI/ADC 輔助但需量化**：惡性浸潤多高 b 值 DWI 高訊號、**ADC 偏低**；良性 reconversion/水腫 ADC 較高，惟造血肥厚與發炎亦可 DWI 亮，視覺判讀不具特異性，須量化 ADC。[^6]
- **良性島的特徵徵象**：bull's-eye sign（T1 病灶中央保有一點脂肪被紅髓包繞）對良性高度特異（敏 ~95%、特 ~99.5%）。[^6]
- **瀰漫 vs 局灶浸潤的分岔**：瀰漫 T1 下降（白血病/瀰漫型骨髓瘤）與瀰漫紅髓 reconversion 不易分辨，須靠 chemical shift/DWI 解題；多發局灶多為轉移或局灶型骨髓瘤。[^4][^6]
...
[^2]: Tier 2／教學文獻彙整：紅髓約 40% 脂肪、40% 水、20% 蛋白，黃髓約 80% 脂肪、15% 水、5% 蛋白；黃髓 T1 與皮下脂肪相當；chemical shift opposed-phase 紅髓掉訊號、腫瘤取代後不掉，>20–25% 訊號下降提示含微觀脂肪（非取代性）。ECR EPOS poster *Bone marrow: normal and pathologic aspects in MRI* / *Imaging spectrum of normal bone marrow on MRI*（epos.myesr.org, ECR 2012/2018）。
[^3]: Tier 2（PMC 全文）Nouh MR, Eid AF. *Magnetic resonance imaging of the spinal marrow: basic understanding of the normal marrow pattern and its variant.* World J Radiol. 2015;7(12):448-458. PMC4697119. 紅髓 T1 須高於椎間盤與肌肉、低於脂肪；conversion 周邊→中央、約 25–30 歲完成、腰椎殘留紅髓；reconversion 斑塊不對稱；chemical shift 20% 訊號下降門檻；gadolinium 增強 35 歲後 <35%。
