---
concepts: [ceus-liver-nodule-patterns]
name: Contrast-Enhanced US (CEUS) — Cirrhotic Liver Nodule Patterns
subspecialty: [US, ABD]
aliases:
  - CEUS liver nodule
...
## 考題
```dataview
list from #交換 where contains(concepts, "ceus-liver-nodule-patterns")
```
