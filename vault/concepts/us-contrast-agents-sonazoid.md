---
concepts: [us-contrast-agents-sonazoid]
name: US Contrast Agent — Sonazoid (Kupffer Phase)
subspecialty: [US]
aliases:
  - Sonazoid
  - Kupffer cell imaging
  - 超音波對比劑Sonazoid
dateRev: 2026-07-02
---
...
**Sonazoid 為第二代超音波對比劑，具有獨特的 Kupffer phase（post-vascular phase）：約注射 10-15 分鐘後，微氣泡被肝臟庫佛氏細胞（Kupffer cell）吞噬而滯留，惡性病灶因缺乏 Kupffer cell 而呈現 defect。**

## Summary
- 被吞噬的細胞：**庫佛氏細胞（Kupffer cell）**，非肝細胞、內皮細胞或星狀細胞。[^1]
...
## 考題
```dataview
list from #交換 where contains(concepts, "us-contrast-agents-sonazoid")
```
