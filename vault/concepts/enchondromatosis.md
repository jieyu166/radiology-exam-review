---
concepts: [enchondromatosis]
name: Enchondromatosis (Ollier Disease & Maffucci Syndrome)
subspecialty: [MSK]
aliases:
  - enchondromatosis
  - Ollier disease
...
- **MRI**:軟骨成分呈 **T2 明顯高訊號分葉狀(lobulated)**、T1 中低訊號,增強呈周邊與分隔(septal/peripheral)強化;MRI 也用於量測病灶範圍、軟組織侵犯與**全身負荷篩檢(whole-body MRI)**。[^2][^3]
...
### 流行病學與監測(背景)
- 惡性轉化(主要為軟骨肉瘤)約見於 **30% 病人**(部分文獻估計總惡性風險可達 ~50%),中位轉化年齡 30–52 歲,但可早至 10 歲;好發轉化部位:股骨、脛骨、肱骨、骨盆、肩胛。多為低惡性度、少轉移,5 年存活 >90%。[^2]
- 共識建議以 **whole-body MRI** 為 baseline 評估骨病灶與血管異常;偵測到血管異常加做 MRA。[^2]

### 判讀陷阱
- **手足內生軟骨瘤本來就常見膨脹、皮質變薄甚至病理性骨折**,在 enchondromatosis 病人手足部位判惡變極困難——MRI 的水腫/骨膜反應等徵象於手足區辨力差,須謹慎。[^3]
- 軟骨肉瘤可**無痛**;單以「會不會痛」判斷良惡並不可靠。[^2]
- 不要把 Maffucci 的**軟組織靜脈石**誤判為其他軟組織鈣化;靜脈石(圓形、可有透亮中心)是血管瘤的線索,而非骨內軟骨基質鈣化。[^1]

> [!note] 考點：哪一項「不」屬 Ollier disease?
> **Soft-tissue hemangiomas（軟組織血管瘤）屬 Maffucci syndrome,不屬 Ollier**。Ollier 為非遺傳、多發性內生軟骨瘤、伴手足變形/肢長不等。[^1]

### 參考來源
[^1]: *Enchondromatosis*. Radiopaedia.org（先前實際查證 accessed 2026-06-18，本次因 403 未能重新讀取，內容延用）：「Ollier disease ... a **non-hereditary, sporadic** skeletal disorder characterized by **multiple enchondromas** principally located in the metaphyseal regions」；DDx「**Maffucci syndrome: presence of soft-tissue hemangiomas**, heralded ... by phleboliths」。另 Primer of Diagnostic Imaging 5th ed., p.314（題目所引）。〔輔助來源，依先前查證紀錄〕
