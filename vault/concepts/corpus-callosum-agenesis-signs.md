---
concepts: [corpus-callosum-agenesis-signs]
name: Agenesis of Corpus Callosum — Imaging Signs
subspecialty: [NR, PE]
aliases:
...
## Summary
- **共同機轉—Probst bundles**：孕期約 8–12 週損傷使胼胝體無法形成；白質束改在半球間裂旁縱向平行走行，將兩側側腦室平行推開。[^1][^2]
- **Racing car sign**：軸位額角／體部平行外移，加上居中的高位擴張第三腦室，形似賽車。[^1][^2]
- **Moose head sign**：冠狀位上翹分離的額角似鹿角，高位第三腦室似頭部；亦稱 trident／Viking helmet。[^1]
- **Colpocephaly**：枕角／三角區不成比例擴大、額角尖角，與缺乏壓部及後方白質束正常發育有關。[^1][^2]
- **鑑別—molar tooth sign**：與 ACC 無關；是 Joubert 症候群及相關疾病的中腦徵象。[^3]
...
## 考題
```dataview
list from #交換 where contains(concepts, "corpus-callosum-agenesis-signs")
```
