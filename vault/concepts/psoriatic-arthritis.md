...
- **Fluffy periostitis**：附著點/骨幹蓬鬆新骨——乾癬之標誌（與類風濕的「純侵蝕」不同）。[^1]
- **"Mouse-ear" 邊緣侵蝕**：DIP 邊緣侵蝕。[^1]
- **Pencil-in-cup / arthritis mutilans**：嚴重溶骨變形。[^1]
- 其他：DIP 為主、不對稱、附著點炎、骶髂/脊椎（不對稱 syndesmophyte）。[^1]
- **非乾癬特徵＝gull-wing erosion**：屬**侵蝕性骨關節炎(erosive OA)**之中央侵蝕（鷗翼狀）。[^1]（2016-083 正解 D）
...
> **Gull-wing erosion**（侵蝕性 OA 之中央侵蝕）。乾癬：sausage digit、fluffy periostitis、mouse-ear 侵蝕、pencil-in-cup。[^1]
