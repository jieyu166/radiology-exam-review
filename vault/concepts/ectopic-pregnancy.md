---
concepts: [ectopic-pregnancy]
name: Ectopic Pregnancy & β-HCG Discriminatory Zone
subspecialty: [ABD]
aliases:
  - ectopic pregnancy
...
## Summary
- **正常懷孕β-HCG動態**：正常子宮內妊娠β-HCG約**每48-72小時倍增**，直至約10,000-20,000 mIU/mL達高原。[^1]
- **判別區（discriminatory zone，本題重點）**：[^1]
  - **經陰道超音波(transvaginal)：約1500-1800 mIU/mL**（多胞胎可至2300）——高於此值應能可靠見子宮內妊娠囊。
  - **腹部超音波(abdominal)：約6000-6500 mIU/mL**。
...
[^4]: **Tier 1** Lin EP, Bhatt S, Dogra VS. *Diagnostic Clues to Ectopic Pregnancy*. RadioGraphics 2008;28(6):1661-1671（DOI [10.1148/rg.286085506](https://doi.org/10.1148/rg.286085506)；實際查證 accessed 2026-07-10）——RadioGraphics 綜論：**判別區——經陰道 US 於 β-hCG >2000 mIU/mL（判別區水平，部分機構採更高閾值）應能顯示妊娠囊、經腹 US 則需達 6500 mIU/mL**；發生部位——**95% 為輸卵管(tubal)妊娠，多見於壺腹部(ampulla, 70%)或峽部(isthmus, 12%)，fimbria 較少(11.1%)**；直接徵象為與卵巢分離之附件腫塊/tubal ring；佐證本概念之判別區與部位分布考點（此文經腹判別區 6500 與本概念一致；經陰道判別區列為 >2000，略高於本概念所述 1500–1800）。
...
## 考題
```dataview
list from #交換 where contains(concepts, "ectopic-pregnancy")
```
