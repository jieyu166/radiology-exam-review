---
concepts: [radiation-induced-changes]
name: Radiation-induced CNS Changes (Post-RT Brain)
subspecialty: [NR]
aliases:
  - radiation-induced changes
  - post-radiation brain changes
  - radiation necrosis
  - pseudoprogression
  - 放射治療後腦部變化
dateRev: 2026-07-10
...
**放療後中樞神經影像變化依『時序』分三期:acute（數天–數週）、early-delayed/subacute（數週–3 個月）、late（>90 天）;判讀核心是用『治療後經過多久 ＋ 標的病灶位置 ＋ 放療野含入多少正常結構』來區分『預期的 post-RT 變化』與『腫瘤復發』。** 判讀分水嶺一：**acute/early-delayed 多為可逆（水腫、somnolence、pseudoprogression）;late 變化多不可逆（白質腦病、放射性壞死、血管病變、次發腫瘤）**;判讀分水嶺二：**放射性壞死 vs 腫瘤復發——壞死 rCBV『低』、choline『不升』、強化呈 soap-bubble/Swiss cheese;腫瘤復發 rCBV『高』、choline『升』**。

## Summary
- **時序三期**[^1]：
  - **Acute（數天–數週）**：疲倦、噁心嘔吐、食慾不振、腦水腫,可有放射性脫髮/皮膚炎;多為自限。風險因子＝照射體積大、單次劑量高、總劑量高、同步化療（尤其 methotrexate）。
  - **Early-delayed / subacute（數週–3 個月）**：症狀類似 acute（頭痛、疲倦、易怒、噁心嘔吐）＋somnolence syndrome;含 **pseudoprogression**（暫時性強化/水腫,尤其 GBM 同步放化療 Stupp protocol 後）。[^1][^2]
  - **Late（>90 天）**：多不可逆、變化多樣。認知功能障礙常見（whole-brain RT;hippocampal-sparing 可減輕）。[^1]
- **Late 白質變化**[^1]：treatment-induced leukoencephalopathy——腦室周圍/深部白質 T2/FLAIR 斑片狀高訊號,隨時間對稱融合;**subcortical U-fibers 與 corpus callosum 通常不受累**;可伴腦萎縮、實質囊變與營養不良性鈣化。
- **放射性壞死（radiation necrosis）**[^3][^4]：放療後**數月–數年**出現的占位性壞死病灶,有質量效應與神經功能障礙;發生率約 **3–26%**（依劑量、同步治療、再照射、累積暴露而異）。
  - **強化型態**：**「soap-bubble／cut green pepper／Swiss cheese」**,偶呈 ring-enhancing。[^3]
...
[^3]: *Cerebral radiation necrosis*. Radiopaedia.org（實際查證 accessed 2026-06-20）：發生率 3–26%;強化型態 soap-bubble/cut green pepper/Swiss cheese;ADC 偏高、SWI 點狀出血;MRS choline/creatine/NAA 低＋lipid/lactate 升;perfusion rCBV 壞死低、腫瘤高。
...
[^6]: **Tier 1** Katsura M, Sato J, Akahane M, Furuta T, Mori H, Abe O. *Recognizing Radiation-induced Changes in the Central Nervous System: Where to Look and What to Look For*. RadioGraphics. 2021;41(1). doi:[10.1148/rg.2021200064](https://doi.org/10.1148/rg.2021200064)（實際查證 accessed 2026-07-10；教學綜述:時序分期、白質/血管/壞死變化、壞死 vs 復發、放療誘發次發腫瘤）。
[^7]: *Radiation-induced meningiomas*. Radiopaedia.org，rID 1952，DOI [10.53347/rID-1952](https://doi.org/10.53347/rID-1952)（實際查證 accessed 2026-07-10）：放療誘發之腦膜瘤較放療誘發膠質瘤（radiation-induced glioma）顯著更常見、常多發且潛伏期很長，為放療誘發顱內腫瘤中最常見者。
...
> [!question]- Which of the following is the least likely radiation-induced CNS neoplasms? (2021-268)
> **B（Lymphomas）**——放療誘發之經典 CNS 續發腫瘤為 meningioma（最常見）、sarcoma、glioma（及周邊神經鞘瘤 PNST）；**lymphoma 並非放療誘發之典型 CNS 腫瘤**，故為「最不可能」者。A meningioma、C glioma、D sarcoma 皆為公認之放療誘發 CNS 腫瘤。
