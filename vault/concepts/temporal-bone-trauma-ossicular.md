---
concepts: [temporal-bone-trauma-ossicular]
name: Temporal Bone Trauma — Ossicular Dislocation
subspecialty: [NR]
aliases:
...
## 考題
```dataview
list from #交換 where contains(concepts, "temporal-bone-trauma-ossicular")
```
