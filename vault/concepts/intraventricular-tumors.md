---
concepts: [intraventricular-tumors]
name: Intraventricular Tumors
subspecialty: [NR]
aliases:
...
判讀腦室內腫塊的第一步永遠是「**它在哪個腔室**＋**病人幾歲**」，這兩個座標就能把鑑別清單砍掉大半;再用強化、鈣化、出血、限制擴散當第二層篩選。[^2]
...
- **Colloid cyst**：典型位於**第三腦室前上方 Monro 孔**,圓形;CT 常**高密度**;MRI 經典為 **T1 高訊號、T2 低訊號**(視內含物而定),Monro 孔處的 T1 高訊號小病灶是辨識訣竅;可造成急性阻塞性腦積水。[^7]
- **Chordoid glioma**：第三腦室前部,細胞來源未明的少見腫瘤,實質性強化腫塊。[^2]
- **Craniopharyngioma**：可向第三腦室前下方延伸;鞍上／第三腦室路徑常含囊變與鈣化。[^2]

### 第四腦室

- **Ependymoma(兒童)**：起自第四腦室底,**經孔「塑形擠出(plastic extrusion)」**——經 Luschka 孔向橋小腦角(約 15%)、經 Magendie 孔向下至上頸髓背側(約 60%);此延展型態比 medulloblastoma 更典型。ADC 較高(平均約 1.1–1.2 ×10⁻³ mm²/s),限制擴散較不明顯。[^8]
- **Medulloblastoma(兒童)**：第四腦室／小腦蚓部,**細胞密度高 → 明顯限制擴散、ADC 低**(平均約 0.7–0.9 ×10⁻³ mm²/s),DWI 高訊號;此低 ADC 是與 ependymoma 鑑別的關鍵。[^8]
- **成人第四腦室**：以 **subependymoma、metastasis、choroid plexus 腫瘤**為主要考量。[^1][^2]
...
[^6]: Intracranial ependymoma and subependymoma: MR manifestations. AJR 1990;154(4):837-845（依摘要,未讀全文）；MR Spectroscopy to Distinguish between Supratentorial Intraventricular Subependymoma and Central Neurocytoma. PMC5600029（依摘要）：subependymoma 幾乎完全腔室內、均質、不強化或輕微強化、無水腫;ependymoma 常跨室管膜延伸並伴水腫。
[^7]: Colloid cyst 影像綜述(StatPearls NBK470314;Roberts, JACEP Open 2021;依摘要,未讀全文)：第三腦室前上 Monro 孔、圓形;CT 常高密度;MRI 經典 T1 高訊號、T2 低訊號(視內含物);可致急性阻塞性腦積水。
[^8]: 第四腦室 ependymoma vs medulloblastoma 鑑別(Imaging of ependymomas: MRI and CT, PMC2744772;AJNR 2010;31:1613 後顱窩腫瘤 DWI;依摘要,未讀全文)：ependymoma 經 Luschka(~15%)、Magendie(~60%)孔塑形擠出,ADC 較高(~1.1–1.2 ×10⁻³);medulloblastoma 細胞密集、ADC 低(~0.7–0.9 ×10⁻³)、DWI 高訊號為鑑別關鍵。
