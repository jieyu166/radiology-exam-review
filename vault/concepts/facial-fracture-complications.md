---
concepts: [facial-fracture-complications]
name: Facial Bone Fracture Complications
subspecialty: [NR]
modality: [CT]
aliases:
...
### 參考來源
[^1]: Winegar, B.A., Murillo, H. & Tantiwongkosi, B., 2013. Spectrum of Critical Imaging Findings in Complex Facial Skeletal Trauma. RadioGraphics, 33(1), pp.3-19.
...
TABLE WITHOUT ID
  ...
  answer AS 答案
FROM "vault/cards"
WHERE contains(concepts, [[facial-fracture-complications]])
SORT file.name ASC
```
