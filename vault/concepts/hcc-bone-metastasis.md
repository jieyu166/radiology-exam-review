---
concepts: [hcc-bone-metastasis]
name: HCC Bone Metastasis — Imaging
subspecialty: [MSK, ABD]
aliases:
  - HCC bone metastasis
  - hepatocellular carcinoma skeletal metastasis
  - blow-out metastasis
  - 肝癌骨轉移
dateRev: 2026-06-15
up: "[[rib-tumor]]"
...
**HCC 骨轉移的招牌＝『溶骨＋膨脹性（blow-out）＋富血管（明顯不均勻強化）＋軟組織腫塊』，好發中軸骨；傳統骨掃描常偽陰性，靠 CT/MRI/PET-CT＋AFP。** 判讀分水嶺一：**溶骨且膨脹（不是成骨）**——HCC 屬少數「blow-out」膨脹性轉移之一；判讀分水嶺二：**富血管→動脈期明顯強化＋軟組織腫塊**，且**骨掃描可漏診**（溶骨、低 osteoblastic 反應）。
...
- **分布（機轉＝血行播散，與原發肝臟左右無關）**：好發**中軸骨/紅骨髓區**——骨轉移**分布與紅骨髓成比例（腰＞胸＞頸）**、脊椎為整體最常見部位[^9]；Kuhlman 系列 22 例之分布（病人數）：**肋骨 13、脊椎 13（並列最常見）、股骨 11、骨盆 7、肱骨 5、顱骨 4**，scapula/sternum/mandible/clavicle 各 1；20/22 多發、2 例孤立[^8]；另一 PET/CT 系列 **骨盆 20%、腰椎 14%、長骨 13%**[^5]。**肋骨是 HCC 骨轉移最常見部位之一，左右側皆可（血行散布，取決於紅骨髓血流，不受肝臟在右側影響）。**[^8][^9]
- **肋骨轉移之型態**：常呈**大的 extrapleural（胸壁）軟組織腫塊＋病理性骨折＋嚴重骨破壞**；近端股骨為大病灶與病理性骨折好發處（自發或輕傷後骨折可為首發）。[^8]
...
## 影像診斷（分模態）
### CT
膨脹性溶骨破壞、皮質破壞±病理性骨折、軟組織腫塊；增強**明顯且不均勻**（富血管，可見壞死/囊變）。溶骨故早期平掃易低估。[^1][^3]
### MRI
T1 iso-/hypo、T2/T2FS hyper（內部不均）、T1FS+C 明顯不均勻強化；界定軟組織與神經血管/椎管侵犯最佳。細胞性灶 **restricted diffusion**。[^6][^7]
### 核醫
**骨掃描常偽陰性**；**PET/CT（FDG±¹¹C-acetate）敏感度遠高**，並提供預後資訊。[^4][^5]

## 鑑別與報告要點
| 重點 | 內容 |
| --- | --- |
| 型態 | 溶骨＋**膨脹性（blow-out）**＋軟組織腫塊[^1][^2] |
| 強化 | **富血管、明顯不均勻**[^1][^3] |
| 膨脹性轉移 DDx | RCC / thyroid / **HCC** / pheo / melanoma / gastric[^2] |
| 偵測陷阱 | **骨掃描偽陰性** → 用 CT/MRI/PET-CT[^4][^5][^6] |
| 線索 | HCC/肝硬化病史、**高 AFP**[^3] |

> [!note] 與 [[rib-tumor]] 的連結
> 在 [[rib-tumor]] 的成人侵襲性肋骨鑑別中，**HCC 骨轉移屬「轉移→膨脹富血管型（RCC/thyroid/HCC）」**：溶骨、膨脹、富血管不均勻強化、軟組織腫塊、可 restricted diffusion。有 HCC 病史＋高 AFP 時應列首位。[^2][^3]

## 範例分析（本院案例）
- **71 歲男性、切片確診 HCC、AFP 最高 750.9 ng/mL**；左第 11 肋 **expansile＋皮質破壞＋病理性骨折＋不均勻強化＋restricted diffusion**。
- 影像型態（膨脹、富血管不均勻強化、軟組織腫塊、restricted diffusion）＋臨床（HCC、高 AFP）**高度符合 HCC 膨脹性富血管骨轉移**，為首位診斷[^1][^2][^3]；切片可確認。
- **「肝在右、肋骨在左」不矛盾**：骨轉移為**血行播散**，分布取決於紅骨髓血流而非原發臟器左右；且**肋骨是 HCC 骨轉移最常見部位之一**（Kuhlman 系列肋骨與脊椎並列居首，各 13/22），左第 11 肋完全相容。[^8]
- **型態高度吻合**：Kuhlman 描述 HCC 肋骨轉移常呈**大 extrapleural 軟組織腫塊＋病理性骨折＋嚴重骨破壞**——與本案 expansile＋皮質破壞＋病理性骨折＋軟組織腫塊一致。[^8]
- 提醒：HCC 骨轉移於骨掃描偵測**文獻分歧**（Kuhlman 增加攝取/gallium avid[^8]；Longo/Seo 常偽陰性[^1][^5]）；不論如何，MRI/CT 已足以顯示侵襲範圍。
...
- **Fig 4**：脊椎壓迫性骨折／椎體破壞。
- **Fig 5**：骨盆（ilium/pubic rami/sacrum）侵襲性溶骨。
- **Fig 6**：CT 顯示未預期之 bulky 軟組織腫塊。
- **Fig 7**：I-131 antiferritin 對骨轉移之 scintigraphic 標靶。

### 參考來源
[^1]: Longo V, Brunetti O, D'Oronzo S, et al. *Bone metastases in hepatocellular carcinoma: an emerging issue*. Cancer Metastasis Rev. 2014;33(1):333-342. https://doi.org/10.1007/s10555-013-9454-4 （Based on articles retrieved from PubMed；摘要：HCC 骨轉移常為 soft-tissue expansion ＋豐富血管、多為溶骨、CT 晚顯、骨掃描常偵測不到）。
[^2]: *Blow out bone metastases*. Radiopaedia.org。膨脹性（blow-out）轉移之原發：RCC、thyroid、HCC、pheochromocytoma、melanoma、gastric carcinoma（實際查證 accessed 2026-06-15）。
[^3]: *Bone metastases*. Radiopaedia.org。轉移占惡性骨腫瘤 70%；型態分 diffuse/focal/expansile、lytic/sclerotic/mixed；HCC 為原發之一（實際查證 accessed 2026-06-15）。
[^4]: *PET/CT Characteristics of Isolated Bone Metastases in Hepatocellular Carcinoma*. Radiology. https://doi.org/10.1148/radiol.10100672 （**院內僅讀到摘要**：HCC 肝外轉移者骨轉移頻率約 19%；dual-tracer PET/CT）。
