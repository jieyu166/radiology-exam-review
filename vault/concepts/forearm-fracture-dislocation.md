---
concepts: [forearm-fracture-dislocation]
name: Forearm Fracture-Dislocations — Monteggia / Galeazzi / Essex-Lopresti
subspecialty: [MSK]
aliases:
  - Monteggia fracture
  - Galeazzi fracture
...
## Summary
- **Monteggia**：尺骨近端骨折 + 橈骨頭脫臼。影響近端橈尺關節，與 DRUJ 無關。[^1]
- **Galeazzi**：橈骨遠端 1/3 骨折 + DRUJ 脫臼。[^1]
...
## 考題
```dataview
list from #交換 where contains(concepts, "forearm-fracture-dislocation")
```
