---
concepts: [superior-orbital-fissure]
name: Superior Orbital Fissure Contents
subspecialty: [NR]
aliases:
  - SOF
  - 上眶裂
...
**Superior orbital fissure (SOF) 通過的神經血管結構包括 CN III、CN IV、CN V1（三叉神經眼支）、CN VI、superior ophthalmic vein。Vidian nerve 不經過 SOF（經由 vidian canal 通 pterygopalatine fossa）。**
