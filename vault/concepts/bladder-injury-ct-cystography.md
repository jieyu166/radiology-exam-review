---
concepts: [bladder-injury-ct-cystography]
name: CT Cystography — Traumatic Bladder Injury Classification
subspecialty: [GU, ABD]
aliases:
  - CT cystography
...
> [!note] 考點：關於疑似創傷性膀胱損傷之CT膀胱攝影，何者錯誤？
...
## 考題
```dataview
list from #交換 where contains(concepts, "bladder-injury-ct-cystography")
```
