---
concepts: [bilateral-subcortical-dwi-hyperintensity-ddx]
name: Bilateral Subcortical (Corticomedullary Junction) DWI Hyperintensity DDx
subspecialty: [NR]
aliases:
...
2. 皮膚切片與腦 MRI 的普及使成人型 NIID 診斷數增加。[^1]
3. NIID 招牌影像＝皮質-髓質交界 DWI 高訊號。[^1]
4. FXTAS 與 NIID 影像可重疊，須臨床／基因鑑別。[^2]
5. Alexander 為額葉型白質失養症，型態與皮質下多灶 DWI 高訊號不同。[^2]
...
## 考題
```dataview
list from #交換 where contains(concepts, "bilateral-subcortical-dwi-hyperintensity-ddx")
```
