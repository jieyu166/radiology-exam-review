---
concepts: [oral-cavity-cancer-ajcc-staging]
name: Oral Cavity Cancer — AJCC 8th Edition T/N Staging
subspecialty: [NR]
aliases:
...
## 考題
```dataview
list from #交換 where contains(concepts, "oral-cavity-cancer-ajcc-staging")
```
