---
concepts: [temporal-bone-inflammatory]
name: Temporal Bone — Inflammatory Lesions
subspecialty: [NR]
aliases:
  - keratosis obturans
  - cholesteatoma EAC
...
## Summary
- **Keratosis obturans**：好發 **<40 歲年輕人**，**50% 雙側**，EAC 內角質碎片堆積。[^1]
- **EAC cholesteatoma**：發生率約 **0.1-0.5%**，EAC 局部骨侵蝕，軟組織密度。[^1]
...
## 考題
```dataview
list from #交換 where contains(concepts, "temporal-bone-inflammatory")
```
