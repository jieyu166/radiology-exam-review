...
**CCTA 的核心價值是「排除（rule-out）」—— 高陰性預測值的非侵入性守門員。** 判讀分水嶺一：NPV 極高（約 99%）→ 陰性幾乎可排除阻塞性狹窄、免去侵入性心導管；判讀分水嶺二：**陽性預測值偏低**（鈣化 blooming 致偽陽性）→ 陽性結果常需 ICA 確認，且 **calcium score 高（>400）會顯著降低 specificity**。
