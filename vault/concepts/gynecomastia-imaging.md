---
concepts: [gynecomastia-imaging]
name: Gynecomastia — Imaging Features
subspecialty: [Breast]
aliases:
  - gynecomastia
  - 男子女乳症
...
> **None of above（D）**——A(最常見男性乳房異常)、B(柔軟可移動觸痛之乳暈下腫塊)、C(急性期可有觸痛)皆為正確描述，無錯誤選項。[^2]

## 考題
```dataview
list from #交換 where contains(concepts, "gynecomastia-imaging")
```
