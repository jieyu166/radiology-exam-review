---
concepts: [pulmonary-hypertension-classification]
name: Pulmonary Hypertension — WHO Classification
subspecialty: [CV, CH]
aliases:
  - pulmonary hypertension WHO groups
...
**WHO 肺高壓分五大組：Group 1＝肺動脈高壓(PAH，含結締組織病/scleroderma)、Group 2＝左心病變、Group 3＝肺病/缺氧、Group 4＝慢性血栓栓塞(CTEPH)、Group 5＝多因子(如 sarcoidosis);PVOD 屬 Group 1'。** 判讀分水嶺：**問『PAH(Group 1)病因』時——scleroderma(CTD-associated, group 1.4.1)屬之;sarcoidosis＝Group 5、cor triatriatum/左心病變＝Group 2、PVOD＝Group 1'(PAH 的特殊亞群,非典型 PAH)。**

## Summary
- **Group 1 — 肺動脈高壓（PAH）**：idiopathic、heritable（BMPR2 等）、藥物/毒素、**結締組織病（scleroderma 等，group 1.4.1）**、HIV、門脈高壓、先天心病、血吸蟲病。[^1]
- **Group 1' — PVOD/PCH**：肺靜脈閉鎖性疾病/肺微血管瘤;屬 Group 1 的特殊亞群。[^1]
- **Group 2 — 左心病變**：左心衰、瓣膜病、**cor triatriatum**、左心房阻塞。[^1]
...
### Pre-capillary vs Post-capillary PH（血流動力學分類）
- **Pre-capillary**：病變侷限**肺動脈循環**（主要在肌肉性動脈層級）;例：idiopathic PAH、缺氧性肺病（COPD/纖維化/胸壁換氣不足）、結締組織病、HIV、長期左向右分流、慢性血栓栓塞、原位肺動脈血栓（紅血球增多症/鐮刀型貧血）、廣泛肺栓塞（惡性細胞/寄生蟲/異物）。[^2]
...
> **Scleroderma（C）**——結締組織病相關 PAH（group 1.4.1）。sarcoidosis 屬 Group 5、PVOD 屬 Group 1'、cor triatriatum 屬 Group 2（左心病變）。[^1]
