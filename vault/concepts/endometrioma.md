...
## Summary
- **T1WI 高訊號**：陳舊出血(option A 對);急性出血偶呈低訊號。[^1]
- **T2WI 低訊號（shading sign）**：去氧血紅素/變性血紅素致 T2 變暗,常見且具特徵(option B 對)。[^1]
...
> **C（post-contrast hypervascular）非典型**——endometrioma無內部強化，出現血管化壁結節要懷疑惡性變。T1高訊號、T2低訊號(shading)皆為典型表現。[^1]
