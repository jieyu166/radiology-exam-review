---
concepts: [hepatic-lymphatic-drainage]
name: Hepatic Lymphatic Drainage (Superficial & Deep Pathways)
subspecialty: [ABD]
aliases:
...
### 解剖與轉移路徑意義
- 肝惡性腫瘤（HCC、膽管癌、轉移）之區域淋巴結轉移最常見於**肝門與 celiac／肝十二指腸韌帶**一線（深層主幹路徑），影像分期時應優先掃視此鏈。[^1]
- 肝上表面／橫膈面病灶可循淺層橫膈—縱膈路徑轉移至**juxtaphrenic／後縱膈**淋巴結。[^1]

## 鑑別與報告要點

| 節站 | 屬深層主幹? | 說明 |
|---|---|---|
| Hepatic hilar（肝門） | 是 | 深層引流首站[^1] |
| Celiac | 是 | 沿肝動脈續行之深層終站[^1] |
| Juxtaphrenic（腔靜脈旁） | 是（沿肝靜脈支） | 繞 IVC 穿橫膈之深層下行/上行支[^2] |
| Lateral diaphragmatic（橫膈外側） | 否 | 橫膈表面／淺層系統，非深層主幹主要節站（正解 D）[^2] |
...
> **D（lateral diaphragmatic nodes）**——celiac、hepatic hilar、juxtaphrenic 屬深層引流主幹（沿門脈—肝動脈與肝靜脈—IVC 路徑）；lateral diaphragmatic 淋巴結引流橫膈本身，屬橫膈表面／淺層系統，非深層主幹主要節站。⚠️ 本題官方詳解僅列標題無內容且含未匯入影像；深層主幹之 hepatic hilar→celiac 與上表面淺層→縱膈路徑已以 Radiopaedia（rID-5726）確認，惟 juxtaphrenic vs lateral diaphragmatic 之精確 deep/superficial 分級係依標準解剖推定，未逐字見於 Radiopaedia／可存取之 Tier-1，判讀請對照原始 RG 圖檔。[^1][^2]

## 考題
```dataview
list from #交換 where contains(concepts, "hepatic-lymphatic-drainage")
```
