---
concepts: [tace-extrahepatic-collateral]
name: TACE — Extrahepatic Collateral (EHC) Arteries to HCC
subspecialty: [IR]
aliases:
  - extrahepatic collateral artery
  - TACE parasitic supply
  - 肝外側枝動脈TACE
dateRev: 2026-07-02
same:
  - "[[tumor-ablation]]"
...
**EHC動脈題的關鍵方位詞是「ventral（腹側）」不是「dorsal（背側）」——鄰近橫膈背側的巨大HCC，該做選擇性血管攝影確認的其實是供應橫膈腹側的動脈（如right inferior phrenic artery），而非誤植的dorsal，這是本題官方標記的唯一錯誤選項。**

## Summary
- **Parasitic supply與TACE次數正相關**：接受TACE次數越多，HCC發展寄生動脈供應（parasitic arterial supply）的機率越高。[^1]
- **Right inferior phrenic artery**：直接接觸肝臟裸區（bare area），為肝臟寄生動脈供應**最常見**來源，可貢獻高達**70%**之HCC寄生供應。[^1]
...
### 參考來源
[^1]: *RadioGraphics* 2017;37:963–977（2018 交換考題詳解 p.235 引用；Tier 1 期刊）。Parasitic arterial supply與TACE次數正相關；right inferior phrenic artery接觸肝臟裸區、貢獻達70%寄生供應；貼近橫膈腹側(ventral，非dorsal)之大型HCC應做right internal mammary artery選擇性血管攝影；intercostal artery microcatheter無法遠端推進時TACE禁忌(脊髓梗塞/皮膚壞死風險)。

## 題目
> [!question]- The development of extrahepatic collateral (EHC) arteries can interfere with the therapeutic efficacy of TACE for hepatocellular carcinoma (HCC). About EHC arteries, which statement is incorrect? (2018-325)
> **Selective angiography of the right internal mammary artery should be performed in patient with large HCC abutting the dorsal aspect of the diaphragm（C）**——正確應為ventral（腹側）aspect，非dorsal。[^1]

## 考題
```dataview
list from #交換 where contains(concepts, "tace-extrahepatic-collateral")
```
