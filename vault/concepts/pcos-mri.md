---
concepts: [pcos-mri]
name: Polycystic Ovary Syndrome — Imaging
subspecialty: [ABD]
aliases:
...
> ![Summary 圖：pcos-mri — summary 圖覆核](https://img-hosting.jieyu166.workers.dev/i/yZ1jO6B.png)
...
- **中央 stroma**：增多、超音波**高回音**、T2 偏低訊號。[^1]
- **卵巢增大**：常見（容積增加）。[^1]（選項 A 典型）
- **多為雙側**。[^1]（選項 C 典型）
