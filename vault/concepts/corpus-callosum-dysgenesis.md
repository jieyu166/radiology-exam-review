---
concepts: [corpus-callosum-dysgenesis]
name: Dysgenesis of Corpus Callosum — Associated Findings
subspecialty: [NR, PED]
aliases:
...
> **Descended tonsil（A）**——屬 Chiari 畸形表現，與胼胝體發育不良無關。Colpocephaly（枕角擴大）、interhemispheric lipoma（常併存）、Probst bundle（致 racing car sign）皆為相關徵象。[^1][^2]

## 考題
```dataview
list from #交換 where contains(concepts, "corpus-callosum-dysgenesis")
```
