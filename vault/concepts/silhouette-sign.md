...
- **Silhouette sign 定位對應**：[^1]
  - **右心緣消失** → RML 或前縱膈/前胸膜。
  - **左心緣消失** → lingula 或前縱膈/前胸膜。
  - **主動脈弓（knob）消失** → **LUL（apicoposterior）** 或中/後縱膈;**非 LLL**。
  - **右橫膈消失** → **RLL**（非 RUL）。
  - **右氣管旁線消失** → RUL。
  - **升主動脈/SVC 緣消失** → RUL anterior segment（前段）。
- **Incomplete border sign（extrapleural sign）**：肺外（胸膜/胸壁/縱膈）病灶呈部分邊界清楚、部分模糊;**但肺內病灶向胸膜/肺外延伸者亦可呈此**（故「不可能是肺病灶」為誤）。[^1]

> [!note] 考點
> 主動脈弓消失＝**LUL**（非 LLL）;右橫膈消失＝**RLL**（非 RUL）;incomplete border sign **亦可見於向肺外延伸的肺病灶**。[^1]
