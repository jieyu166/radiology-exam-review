...
name: Aortic Stenosis (AS) — Imaging & CT
subspecialty: [CV]
aliases:
  - aortic stenosis
  - aortic valve area
...
> [!note] 考點：有關aortic stenosis何者「為非」？
> **用CT評估狹窄程度時需用ECG-gated cardiac CTA、舒張期取像（C）**——應為**收縮中期（midsystole）**取像(瓣膜開啟相對靜止)，非舒張期。好發70歲以上(A對)、severe AS瓣口<100mm²常伴鈣化(B對)、TAVI經導管置換(D對)皆為正確描述。[^1]
...
## 臨床重點（5 句）
- 退化性鈣化性 AS 為老年最常見瓣膜病，與年齡、高血壓、脂質及慢性發炎相關，病程進行性。[^2]
- 典型症狀三聯為心絞痛、暈厥與心衰竭，症狀出現後若不治療預後顯著惡化。[^2]
- Severe symptomatic AS 為介入指標；治療選項為外科換瓣（SAVR）與經導管置換（TAVI/TAVR）。[^2]
- 現行歐洲與美國指引中，TAVI 於高齡與較高手術風險者已成主流，且逐步擴及低風險族群。[^2]
- 治療決策由多專科 Heart Team 依年齡、手術風險、解剖與共病共同決定。[^2]
...
> **用電腦斷層評估狹窄程度時需要用ECG-gated cardiac CTA舒張期取像（C）**——應於收縮中期(midsystole，瓣膜開啟相對靜止)取像，非舒張期。[^1]

> [!question]- 關於 severe aortic stenosis 的描述，何者為非? (2021-139)
> **B（severe AS 定義為心臟「舒張期」主動脈瓣開口面積 <100 mm²）為非**——瓣口面積須於**收縮期**（瓣膜開啟）量測，舒張期主動脈瓣是關閉的，故 B 之「舒張期」錯誤；C（收縮期 <100 mm²）才正確。A(好發 70 歲以上老人)、D(瓣膜常伴鈣化)皆正確。[^1]

> [!question]- 有關 pre-procedure CT for percutaneous aortic valve implantation (TAVI)，下列何者為非? (2021-160)
> **A（為使影像清楚，scan 前最好使用 beta-blocker 及 NTG）為非**——NTG 與 beta-blocker 在 severe AS 為禁忌，掃描前不應給予。B(評估 aortic valve/annulus/sinus 及入路動脈)、C(需一組 cardiac motion-free 影像、用 ECG gating)、D(收縮期瓣膜最大，測量以收縮期為主)皆正確。[^2][^3]

## 考題
```dataview
list from #交換 where contains(concepts, "aortic-stenosis")
```
