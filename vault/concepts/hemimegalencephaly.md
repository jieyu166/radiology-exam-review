...
## Summary
- **本質**：先天畸形，因**細胞組織結構與神經元移行缺陷(defect of cellular organization and neuronal migration)**，致一側大腦半球錯構瘤樣過度生長。[^1]
...
> **Decreased signal of white matter on T1-weighted MR images caused by reduced myelination（D）**——實際為加速髓鞘化致T1訊號增高，非減少。[^1]

## 考題
```dataview
list from #交換 where contains(concepts, "hemimegalencephaly")
```
