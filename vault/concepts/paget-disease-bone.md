---
concepts: [paget-disease-bone]
name: Paget Disease of Bone — Imaging Signs
subspecialty: [MSK]
aliases:
...
## Summary
- **Blade-of-grass appearance（長骨）**：Paget disease 溶骨期在長骨呈**尖端似草葉狀（V字形/火焰狀）**的溶骨前緣，代表病灶侵犯前緣。[^1]
- **Cotton-wool appearance（顱骨）**：Paget disease 硬化期顱骨呈**棉絮狀**混合硬化與溶骨區域。[^1]
...
[^5]: *Imaging of Paget Disease of Bone and Its Musculoskeletal Complications: Review*. AJR Integrative Imaging 2011;196（2018 交換考題詳解 p.342/344 引用；Tier 1 期刊）。病理標誌為異常的骨吸收與骨再形成(abnormal bone resorption and apposition);好發於腰薦椎、骨盆、股骨、顱骨等中軸骨,手部小骨/肩部/肋骨少見。
...
> [!question]- Which of the following pathologic characteristics is the hallmark of Paget disease of bone? (2018-430)
> **Abnormal bone resorption and apposition（C）**——Paget disease病理標誌為異常的骨吸收與骨再形成並存且失序。非單純「骨吸收增加(A)」、「大量新骨形成(B)」或「代償形成優質骨(D)」。[^5]

> [!question]- Paget disease of bone is more common in which of the following locations? (2018-074)
> **Lumbosacral spine（A）**——Paget disease好發於腰薦椎、骨盆、股骨、顱骨等中軸骨。Shoulders(B)、Ribs(C)、Small bones in the hand(D)相對少見。[^5]

## 考題
```dataview
list from #交換 where contains(concepts, "paget-disease-bone")
```
