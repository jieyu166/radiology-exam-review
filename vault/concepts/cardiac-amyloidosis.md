---
concepts: [cardiac-amyloidosis]
name: Cardiac Amyloidosis — MRI Manifestations
subspecialty: [CV]
aliases:
...
**心臟類澱粉沉積典型MRI表現是延遲強化型態（心內膜下或透壁性）與心室壁增厚，「心室壁運動不能」不是其典型特徵描述。**

## Summary
- **延遲強化（LGE）型態**：可呈**透壁性（transmural）**或**心內膜下（subendocardial）**延遲強化，兩者皆為文獻記載之典型表現。[^1]
- **室壁增厚（ventricular wall thickening）**：類澱粉蛋白沉積於心肌間質，造成心室壁**增厚**，為典型表現之一。[^1]
...
## 臨床重點（5 句）
- 心臟類澱粉沉積主要分兩型：AL 型（免疫球蛋白輕鏈，與漿細胞病變/多發性骨髓瘤相關）與 ATTR 型（transthyretin，含老年野生型與遺傳型）。[^1]
- 臨床以進行性**限制型心衰竭**、運動耐受下降、姿勢性低血壓與傳導障礙（心律不整、傳導阻滯）表現。[^1]
- 心電圖常見**肢導低電壓合併心室壁增厚**的「電壓-質量不匹配」，是重要臨床線索。[^1]
- 治療分型決定預後與策略：AL 型需血液腫瘤科化療/自體幹細胞移植，ATTR 型可用 tafamidis 等 TTR 穩定劑，故確診分型至關重要。[^1]
- AL 型若延誤診斷預後差，早期辨識與轉介（含心臟切片/骨掃描核醫檢查輔助分型）可改變治療結果。[^1]

> [!note] 考點：何者「非」典型心臟類澱粉沉積表現？
...
## 考題
```dataview
list from #交換 where contains(concepts, "cardiac-amyloidosis")
```
