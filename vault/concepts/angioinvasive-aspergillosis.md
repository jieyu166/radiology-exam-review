---
concepts: [angioinvasive-aspergillosis]
name: Angioinvasive / CNS Aspergillosis
subspecialty: [NR, CH]
aliases:
...
## Summary
- **宿主**：免疫低下，包括 AIDS、長期高劑量類固醇、嗜中性球低下與移植。[^1]
- **強化**：因免疫反應弱，病灶強化微弱或不規則；「multiple nodules with strong ring enhancement」為假（2016-162 正解 A），強烈均勻環狀強化較像化膿性膿瘍。[^1]
- **周邊 T2 低訊號**：膿瘍周邊因出血／真菌元素呈低 T2，GRE/SWI 更明顯（option D 對）。[^1]
- **擴散**：不同於化膿性膿瘍的均勻高 DWI，麴菌擴散受限常異質，可呈周邊／環狀（ring-like、peripheral）（option B、C 對）。[^1]
- **血管侵犯**：可造成腦梗塞、黴菌性動脈瘤與出血。[^1]
