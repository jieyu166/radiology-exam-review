---
concepts: [meniscal-tear-patterns]
name: Meniscal Tear Patterns — Wrisberg Rip & Ligament Association
subspecialty: [MSK]
aliases:
  - Wrisberg rip
...
## 考題
```dataview
list from #交換 where contains(concepts, "meniscal-tear-patterns")
```
