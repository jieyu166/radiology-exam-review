...
name: Cervical Cancer — MRI & Staging
subspecialty: [ABD]
aliases:
...
- **Hydronephrosis / 無功能腎**：→ **FIGO IIIB（T3b）**(option C 影響分期)。[^1]
- **骨盆/主動脈旁淋巴結**：影響 N 期與預後(option D 影響 TNM)。[^1]
- **腫瘤侵犯子宮體（uterine corpus）**：**不改變 FIGO 分期** → 故為「不影響分期」之正解（2016-195 正解 A）。[^1]

> [!note] 考點：何者「不」影響子宮頸癌分期?
> **腫瘤侵犯子宮體（uterine corpus）**。parametrium 侵犯、hydronephrosis、淋巴結轉移皆影響分期。[^1]

### 參考來源
[^1]: 子宮頸癌 FIGO/TNM 分期與 MRI（標準婦科腫瘤影像）：**parametrium 侵犯→IIB、hydronephrosis→IIIB、淋巴結→N/預後**;**子宮體（corpus）延伸不改變 FIGO 分期**;MRI 以 T2 評基質環完整性。
