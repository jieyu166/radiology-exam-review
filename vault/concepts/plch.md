...
- **影像（CT）**：ill-defined centrilobular nodules → cavitating nodules → **bizarre-shaped 厚/薄壁囊腫**；**上中肺野為主、保留肋膈角**。[^1]
- **臨床**：非特異咳嗽、呼吸困難；約 1/3 有體質性症狀（發燒、體重減輕、疲倦）；易發**自發性氣胸**。[^1]
- **吸菸相關譜系**：屬「直接吸菸相關」組（RB/RB-ILD/AMP/PLCH/SRIF）；LAM 不在此譜系。[^1]

## 影像診斷
### CT / HRCT
早期以 **ill-defined centrilobular 結節**為主，結節可空洞化，進而形成**奇形怪狀（bizarre）厚薄壁囊腫**；**上中肺野分布、肋膈角（lung bases）相對保留**——此 sparing 是與其他囊性肺病的鑑別特徵。[^1]

> [!note] 為何「保留肋膈角」重要
> PLCH 上中肺偏好且**保留肋膈角**；LAM 則瀰漫均勻、不保留肋膈角。這是 cystic lung disease 鑑別的關鍵分水嶺。[^1]

## 鑑別與報告要點
| 病灶 | 分布 | 型態 | 族群/關鍵 |
| --- | --- | --- | --- |
| **PLCH** | 上中肺、**保留肋膈角** | 結節→空洞→bizarre 囊腫 | 20–40 歲吸菸者、>95% 吸菸、BRAF V600E[^1] |
| **LAM** | 瀰漫均勻、不保留肋膈角 | 薄壁圓形囊 | 育齡女性、非吸菸（見 [[lam]]）|
| **IPF/UIP** | 基底+subpleural | honeycombing/纖維化 | 年長（見 [[ipf]]）|
