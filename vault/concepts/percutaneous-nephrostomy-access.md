---
concepts: [percutaneous-nephrostomy-access]
name: Percutaneous Nephrostomy — Ideal Access Route
subspecialty: [GU]
aliases:
  - PCN access
...
## 考題
```dataview
list from #交換 where contains(concepts, "percutaneous-nephrostomy-access")
```
