---
concepts: [cpa-masses]
name: Cerebellopontine Angle (CPA) Masses — DDx
subspecialty: [NR, H&N]
aliases:
...
- **PWI 無法區分者（考點）**：**meningioma 與 metastasis 皆呈高 rCBV（高灌流）**，故 perfusion 難以可靠分辨此二者——為 2022-446 之答案。[^4]

> [!note] 2022-446 考點
> perfusion‑weighted MRI 可鑑別多數 CPA 病灶對配，**唯獨 meningioma 與 metastasis（皆高 rCBV／高灌流）無法可靠區分（E）**。[^4]

## 放射科醫師影像判讀重點（顱神經與 CPA，Q490）
- **CPA 池的顱神經（考點）**：**內容物＝CN VII、VIII（進入 IAC）**；**上界與 CN V（三叉神經）相關、下界與 CN IX、X、XI（頸靜脈孔群）相關**；CN VI（外展神經）沿相鄰橋前池上行——故 V、VI、IX、X 皆與 CPA/橋前區有解剖關係。[^5]
- **不行經 CPA 者＝CN XII（判讀分水嶺）**：**舌下神經（XII）起自延髓前橄欖溝、經舌下神經管出顱，位置在延髓/下方，不行經 CPA**——為「哪條顱神經不經過 CPA」的答案。[^5]

## 題目
> [!question]- Regarding lesions that may occur in the CPA region, perfusion-weighted MRI may potentially differentiate between each of the following EXCEPT: (2022-446)
> **Meningioma and metastasis（E，關鍵）**——兩者皆為高灌流（高 rCBV），PWI 無法可靠區分。其餘對配灌流型態不同故可鑑別：schwannoma（低‑中）vs meningioma（高）（A）、lymphoma（低）vs metastasis（高）（B）、abscess vs metastasis（C）、hemangioblastoma（極高）vs lymphoma（低）（D）。[^4]

> [!question]- Which cranial nerve does not course through the cerebellopontine angle? (2022-490)
> **E. XII（關鍵）**——舌下神經（CN XII）起自延髓前橄欖溝、經舌下神經管出顱，不行經 CPA。CN V（A）位 CPA 上界、CN VI（B）沿相鄰橋前池上行、CN IX（C）與 X（D）屬 CPA 下界頸靜脈孔群，皆與 CPA/橋前區有解剖關係。[^5]
