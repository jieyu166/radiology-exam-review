---
concepts: [avulsion-fracture-attachments]
name: Tendon/Ligament Avulsion Fracture Attachment Sites
subspecialty: [MSK]
aliases:
  - avulsion fracture
  - Segond fracture
...
## Summary
- **Segond fracture**：**外側關節囊韌帶（lateral capsular ligaments）**於脛骨外側平台邊緣之撕脫骨折（正面 X 光稱 lateral capsular sign）；**~75% 伴隨ACL斷裂**、機轉為 internal rotation + varus stress，但骨折附著結構本身為外側關節囊韌帶／anterolateral ligament（ALL）複合體，非ACL本身。[^1][^2]
- **Gerdy's tubercle fracture**：**iliotibial band（腸脛束）**於脛骨外側Gerdy氏結節之撕脫。[^1]
...
## 考題
```dataview
list from #交換 where contains(concepts, "avulsion-fracture-attachments")
```
